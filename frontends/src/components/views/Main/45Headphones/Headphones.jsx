...
import BackgroundImage from './Images/earbudheader.webp'
...
function Headphones() {
  ...
  const [GamePhones, setGamePhones] = useState([])
  ...
  const [HeadphoneValue, setHeadphoneValue] = useState("Headphone")
  const [GamingValue, setGamingValue] = useState("Headset")
  const [EarbudValue, setEarbudValue] = useState("Earbuds")
  const [AirpodValue, setAirpodValue] = useState("AirPods")
  const [EarPodValue, setEarPodValue] = useState("EarPods")
  const [AirpodMaxValue, setAirpodMaxValue] = useState("AirPod Max")
...
.then(response => {
  ...
  if (response.data.success) {
    ...
    setGamePhones(response.data.products)
  } else {
  }
  })
  ...
  const SearchedProducts = Products.map((product, index) => {
    ...
    const WiredAirpodMaxPage = AirpodMax.map((product, index) => {
    ...
    const WiredEarPodsPage = EarPods.map((product, index) => {
      ...
      const WirelessEarPodsPage = EarPods.map((product, index) => {
        if (product.interface === "Wireless") {
        return (
          <div key={index} className='listing-Item'>
          <div className='listing-Details'>
    ...
    const WiredHeadphonesPage = Headphones.map((product, index) => {
      ...
      const WirelessHeadphonesPage = Headphones.map((product, index) => {
        ...
        const WiredGamePhonesPage = GamePhones.map((product, index) => {
          if (product.interface === "Wired") {
          return (
            <div key={index} className='listing-Item'>
            <div className='listing-Details'>
          ...
          const WirelessGamePhonesPage = GamePhones.map((product, index) => {
            if (product.interface === "Wireless") {
            return (
              <div key={index} className='listing-Item'>
              <div className='listing-Details'>
              ...
              const WirelessEarbudsPage = Earbuds.map((product, index) => {
                ...
                return (
                  ...
                  <div className='Company-listing_logo'>
                    ...
                    const WiredAirpodsPage = Airpods.map((product, index) => {
                      if (product.interface === "Wired") {
                      return (
                        <div key={index} className='listing-Item'>
                        <div className='listing-Details'>
  ...
  <div className='Visited_page-banner'>
    <div className='Page_banner-style'>
      ...
      <img 
      // src='https://media.pitchfork.com/photos/60c2315c28fd170dc6ddd146/2:1/w_2560%2Cc_limit/earbudheader.png'
      src={BackgroundImage} 
      className='Background_Image_style'/>
    </div>
      ...
      <div className="Brand_options_listed">
        ...
        <div className='Memomry_size_option-list'>
          ...
          className={toggleMemorySizeDesktop ===2 ? "Memory_size_option_selected_style active-Memory_size_option_selected_style" : "Memory_size_option_selected_style"}>
            Wireless
          </button>
          </div>
      </div>
...
<div className={toggleBrands === 1 && toggleMemorySizeDesktop === 1 ? "Listed_fetched_products" : "Listed_fetched_products-hide"}>
  {WiredEarbudsPage}
</div>

<div className={toggleBrands === 1 && toggleMemorySizeDesktop === 2 ? "Listed_fetched_products" : "Listed_fetched_products-hide"}>
  {WirelessEarbudsPage}
</div>

<div className={toggleBrands === 2 && toggleMemorySizeDesktop === 1 ? "Listed_fetched_products" : "Listed_fetched_products-hide"}>
  {WiredHeadphonesPage}
</div>

<div className={toggleBrands === 2 && toggleMemorySizeDesktop === 2 ? "Listed_fetched_products" : "Listed_fetched_products-hide"}>
  {WirelessHeadphonesPage}
</div>

<div className={toggleBrands === 3 && toggleMemorySizeDesktop === 1 ? "Listed_fetched_products" : "Listed_fetched_products-hide"}>
  {WiredGamePhonesPage}
</div>

<div className={toggleBrands === 3 && toggleMemorySizeDesktop === 2 ? "Listed_fetched_products" : "Listed_fetched_products-hide"}>
  {WirelessGamePhonesPage}
</div>

<div className={toggleBrands === 5 && toggleMemorySizeDesktop === 1 ? "Listed_fetched_products" : "Listed_fetched_products-hide"}>
  {WiredEarPodsPage}
</div>

<div className={toggleBrands === 5 && toggleMemorySizeDesktop === 2 ? "Listed_fetched_products" : "Listed_fetched_products-hide"}>
  {WirelessEarPodsPage}
</div>

<div className={toggleBrands === 6 && toggleMemorySizeDesktop === 1 ? "Listed_fetched_products" : "Listed_fetched_products-hide"}>
  {WiredAirpodsPage}
</div>

<div className={toggleBrands === 6 && toggleMemorySizeDesktop === 2 ? "Listed_fetched_products" : "Listed_fetched_products-hide"}>
  {WirelessAirpodsPage}
</div>

<div className={toggleBrands === 7 && toggleMemorySizeDesktop === 1 ? "Listed_fetched_products" : "Listed_fetched_products-hide"}>
  {WiredAirpodMaxPage}
</div>

<div className={toggleBrands === 7 && toggleMemorySizeDesktop === 2 ? "Listed_fetched_products" : "Listed_fetched_products-hide"}>
