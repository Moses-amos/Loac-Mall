...
function KitchenAppliances() {
  ...
  const [RefrigeratorsValue, setRefrigeratorsValue] = useState("Refrigerator")
  const [StovesValue, setStovesValue] = useState("Cooking Appliance")
  const [CooktopsValue, setCooktopsValue] = useState("Cooktop")
  const [OvensValue, setOvensValue] = useState("Wall Oven")
  const [FreezersValue, setFreezersValue] = useState("Freezer")
  const [DishwashersValue, setDishwashersValue] = useState("Dishwasher")
  const [MicrowavesValue, setMicrowavesValue] = useState("Microwave")
...
.then(response => {
  ...
  if (response.data.success) {
    ...
    setStoves(response.data.products)
  } else {
  }
  })
  ...
  if (response.data.success) {
    ...
    setOvens(response.data.products)
  } else {
  }
  })
  ...
  const StovesPage = Stoves.map((product, index) => {
    return (
      <div key={index} className='listing-Item'>
      <div className='listing-Details'>
          <a href={`/product/${product._id}`}> <div className='Item-image'>
...
const CooktopsPage = Cooktops.map((product, index) => {
  return (
    <div key={index} className='listing-Item'>
    <div className='listing-Details'>
        <a href={`/product/${product._id}`}> <div className='Item-image'>
...
const OvensPage = Ovens.map((product, index) => {
  return (
    <div key={index} className='listing-Item'>
    <div className='listing-Details'>
        <a href={`/product/${product._id}`}> <div className='Item-image'>
...
const FreezersPage = Freezers.map((product, index) => {
  return (
    <div key={index} className='listing-Item'>
    <div className='listing-Details'>
        <a href={`/product/${product._id}`}> <div className='Item-image'>
