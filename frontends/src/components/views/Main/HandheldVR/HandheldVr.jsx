...
function HandheldVr() {
    ...
    const [VRConsole, setVRConsole] = useState([])
    ...
    const [VRSetValue, setVRSetValue] = useState("Virtual Reality")
    ...
    .then(response => {
      ...
      if (response.data.success) {
        ...
        setVRConsole(response.data.products)
      } else {
      }
      })
      ...
      const SearchedProducts = Products.map((product, index) => {
        ...
        const HandheldConsolePage = HandheldConsole.map((product, index) => {
            ...
            const SteamConsolePage = SteamConsole.map((product, index) => {
                return (
                    <div key={index} className='listing-Item'>
                    <div className='listing-Details'>
                        <a href={`/product/${product._id}`}> <div className='Item-image'>
          ...
          const OneXPlayerConsolePage = OneXPlayerConsole.map((product, index) => {
            return (
              <div key={index} className='listing-Item'>
              <div className='listing-Details'>
                  <a href={`/product/${product._id}`}> <div className='Item-image'>
            ...
            const MetaQuestPage = VRConsole.map((product, index) => {
                if (product.seriesName === "Meta Quest 2") {
                  return (
                      <div key={index} className='listing-Item'>
                      <div className='listing-Details'>
                          <a href={`/product/${product._id}`}> <div className='Item-image'>
            ...
            const MetaQuestProPage = VRConsole.map((product, index) => {
              if (product.seriesName === "Meta Quest Pro") {
                return (
                    <div key={index} className='listing-Item'>
                    <div className='listing-Details'>
                        <a href={`/product/${product._id}`}> <div className='Item-image'>
            ...
            const PlayStationVRPage = VRConsole.map((product, index) => {
              if (product.seriesName === "PlayStation VR 2") {
                return (
                    <div key={index} className='listing-Item'>
                    <div className='listing-Details'>
                        <a href={`/product/${product._id}`}> <div className='Item-image'>
          ...
          const HPReverbPage = VRConsole.map((product, index) => {
            if (product.seriesName === "HP Reveb G2") {
              return (
                  <div key={index} className='listing-Item'>
                  <div className='listing-Details'>
                      <a href={`/product/${product._id}`}> <div className='Item-image'>
        ...
        const OtherVRPage = VRConsole.map((product, index) => {
