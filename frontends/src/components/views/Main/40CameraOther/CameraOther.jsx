...
function CameraOther() {
  ...
  const [WebcamsValue, setWebcamsValue] = useState("Webcam")
  const [ProjectorsValue, setProjectorsValue] = useState("Projector")
...
.then(response => {
  ...
  if (response.data.success) {
    ...
    setWebcams(response.data.products)
  } else {
  }
  })
  ...
  const SearchedProducts = Products.map((product, index) => {
    ...
    const ActionCameraPage = Cameras.map((product, index) => {
      if (product.seriesName === "Action Camera") {
      return (
    ...
    const MirrorlessPage = Cameras.map((product, index) => {
      if (product.seriesName === "Mirrorless") {
      return (
        <div key={index} className='listing-Item'>
        <div className='listing-Details'>
            <a href={`/product/${product._id}`}> <div className='Item-image'>
    ...
    const WebcamsPage = Webcams.map((product, index) => {
      return (
        <div key={index} className='listing-Item'>
        <div className='listing-Details'>
            <a href={`/product/${product._id}`}> <div className='Item-image'>
