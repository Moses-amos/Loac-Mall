...
function Sidemenu(props) {
  ...
  return (
    <ul className='_Client_User_page_sidebar'>
        <li 
         className='CLient_sidebar_header_User'>
            <div className='_Client_sidebar_li_height_svg'>
            ...
            <div className='Overview_padding_left'>
                <NavLink className='CLient_sidebar_titles_User' to={'/overview'}> 
                <div className='Cliet_sidebar_text_active'>
                Overview
                        </div>
                </NavLink>
                </div> </li> 
                <li 
                    ...
                    <div style={{ paddingLeft: '13px'}}>
                        <NavLink className='CLient_sidebar_titles_User' to={'/wishlist'}> 
                        <div className='Cliet_sidebar_text_active'>
                        Wishlist
                        </div>
                        </NavLink> </div> 
                       ...
                       <li 
                            ...
                            <div className='Request_padding_left'>
                                <NavLink className='CLient_sidebar_titles_User' to={'/request-made'}>
                                    <div className='Cliet_sidebar_text_active'>
                                    Requests
                                    </div>
                                </NavLink>
                            ...
                            <div style={{ paddingLeft: '13px'}}>
                                <NavLink className='CLient_sidebar_titles_User' to={'/0settings'}>
                                    <div className='Cliet_sidebar_text_active'>
                                    Settings
                                    </div>
                                </NavLink>
                            ...
                            <div style={{ paddingLeft: '15px'}}>
                                <div className='CLient_sidebar_titles_User' 
                                
                                >
                                    <div className='Cliet_sidebar_text_active'>
                                    <span onClick={() => { refreshPage(); logoutHandler() }}>logout</span>
                                    </div>
                                </div>
                                    </div> </li> 
