...
import AccountOne from './AccountOne.svg'
import Accountsecond from './Accountsecond.svg'
...
function RightMenu(props) {
  ...
  if (user.userData && !user.userData.isAuth) {
    return (
      ...
      <div className='Cart-user_main'>
        <a href="/login" className='Cart-link'>
       ...
       <svg aria-label="Cart Icon" role="img" width="26px" height="26px"
        xmlns="http://www.w3.org/2000/svg" fill="#333" viewBox="0 0 32 32"
      ...
      <div className='Cart-user_main'>
        ...
        <div className={cartColor? "Cart-Box_Hover": "Cart-Box"} onMouseLeave={cartHover} onMouseEnter={cartHover}>
        <Badge >
       <svg width="26px" height="26px" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M13 9.00021H17.0017" stroke="#333" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path><path d="M6.99609 8.72507L7.91548 9.55341L9.76625 7.88672" stroke="#333" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path><path d="M9.99901 20.0036H7.99818C5.2356 20.0036 2.99609 17.7641 2.99609 15.0015V6.99818C2.99609 4.2356 5.2356 1.99609 7.99818 1.99609H16.0015C17.3281 1.99609 18.6004 2.5231 19.5385 3.46117C20.4766 4.39924 21.0036 5.67154 21.0036 6.99818V9.99943" stroke="#333" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path><path d="M6.99609 13.729L7.91548 14.5573L9.76625 12.8906" stroke="#333" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path><path d="M14 13.9023V19.6051C14.001 20.3783 15.5674 21.0055 17.501 21.0055C19.4345 21.0055 21.0009 20.3783 21.0019 19.6051V13.9023" stroke="#333" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path><path d="M14 16.7539C14 17.5271 15.5674 18.1543 17.501 18.1543C19.4345 18.1543 21.0019 17.5271 21.0019 16.7539" 
       stroke="#333" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path>
       <path d="M14.001 13.9004C14.001 14.6736 15.5684 15.3008 17.502 15.3008C19.4355 15.3008 21.0019 14.6736 21.0019 13.9004C21.0019 13.1262 19.4335 12.5 17.501 12.5C15.5684 12.5 14.001 13.1272 14 13.9004" stroke="#333" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path></svg>
      </Badge>
        </div>
      </a>
      </div>

      <div className='Navbar_signin_mobile'>
        <a href="/login" className='Cart-link'>
        <div className={cartColor? "Cart-Box_Hover": "Cart-Box"} onMouseLeave={cartHover} onMouseEnter={cartHover}>
        <Badge >
        <svg viewBox="0 0 24 24" width="24"><image height="100%" 
        href={AccountOne} width="100%"
         xlinkHref={Accountsecond}></image></svg>
      </Badge>
        </div>
      </a>
      </div>

      <div className='User-account-nav_main'> 
    ...
    return (
        <div className='Navbar-selects-nav' mode={props.mode}>
          ...
          {user.userData.operateLocation === "Admin" ?
          <>
          <div className='Cart-user_main'>
      ...
      <a href="/user/cart" className='Cart-link'>
            ...
            <Badge count={user.userData && user.userData.cart.length}>
           {/* <Icon type="shopping-cart" className='Cart-Icon' /> */}
           <svg aria-label="Cart Icon" role="img" width="24px" height="24px"
            xmlns="http://www.w3.org/2000/svg" fill="#333" viewBox="0 0 32 32"
            xmlSpace="preserve"><path d="M9.829 19.824h17.575c.452 0 .845-.31.951-.75l2.9-12.137a.978.978 0 0 0-.952-1.205H9.876a.978.978 0 0 0 0 1.955h19.188L26.632 17.87H9.829c-.064 0-.124.015-.188.019L6.107 1.818a.978.978 0 0 0-.955-.769H1.697a.978.978 0 0 0 0 1.956h2.669l3.418 15.543a3.465 3.465 0 0 0-1.432 2.797c0 1.304.73 2.428 1.793 3.023a3.994 3.994 0 0 0-.932 2.548 4.04 4.04 0 0 0 4.034 4.035 4.04 4.04 0 0 0 4.035-4.035c0-.77-.228-1.482-.603-2.094h7.59a3.999 3.999 0 0 0-.597 2.094c0 2.225 1.809 4.035 4.034 4.035s4.034-1.81 4.034-4.035c0-1.926-.914-2.916-1.682-3.407-.936-.6-1.956-.647-2.247-.647-.024 0-.042.004-.065.005H9.83a1.523 1.523 0 0 1-1.521-1.522c0-.838.682-1.521 1.521-1.521zm1.418 9.172a2.082 2.082 0 0 1-2.079-2.08c0-1.146.933-2.08 2.08-2.08s2.078.934 2.078 2.08-.932 2.08-2.079 2.08zm16.539-2.08c0 1.147-.934 2.08-2.08 2.08a2.082 2.082 0 0 1-2.08-2.08c0-1.146.934-2.08 2.08-2.08H25.719c.06 0 .119-.006.175-.017.29.013.91.113 1.34.515.366.341.552.874.552 1.582z"></path></svg>
          </Badge>
            </div>
                ...
                <ul className='Dropdown-ul'>
                  ...
                  <a className='Dropdown-a-user' href={`/0/${user.userData._id}`}>
                    <div className='Route-span-user'>
                      <span className='Route-span-style'>Marketing Account</span>
                    </div>
                    <div className='Route-icon-user'>
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M13 10.0002H17.0017" stroke="#FFCE73" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path>
                    <path d="M6.99609 9.72507L7.91548 10.5534L9.76625 8.88672" stroke="#FFCE73" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path><path d="M6.99609 14.729L7.91548 15.5573L9.76625 13.8906" stroke="#FFCE73" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path>
                    <path d="M20.0019 20.0058L18.1211 18.125" stroke="#FFCE73" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path><circle cx="16.0012" cy="16.0012" r="3.00125" stroke="#FFCE73" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></circle>
                    <path d="M21.0036 11.1658V7.49797C21.0036 5.01165 18.988 2.99609 16.5017 2.99609H7.49797C5.01165 2.99609 2.99609 5.01165 2.99609 7.49797V16.5017C2.99609 18.988 5.01165 21.0036 7.49797 21.0036H10.9994" stroke="#FFCE73" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path></svg>                 
                    </div>
                    </a>
                  </li>
                  <li className="Dropdown-li-user">
                  <a className='Dropdown-a-user'>
                    <div className='Route-span-user'>
                  ...
                  <>
                  <li className="Dropdown-li-user">
                  <a className='Dropdown-a-user' href='/overview'>
                    <div className='Route-span-user'>
                  ...
                  <li className="Dropdown-li-user">
                  <a className='Dropdown-a-user' href='/request-made'>
                    <div className='Route-span-user'>
                      <span className='Route-span-style'>Requests</span>
                    </div>
                    <div className='Route-icon-user'>
