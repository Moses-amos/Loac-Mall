...
import './tabletaccessories.css'

function TabletAccessories() {
  ...
  const [TabletCase, setTabletCase] = useState([])
  const [Popsockets, setPopsockets] = useState([])
  const [SmallKeyboard, setSmallKeyboard] = useState([])
  const [Stylus, setStylus] = useState([])
  const [TabletStand, setTabletStand] = useState([])
  const [ScreenSaver, setScreenSaver] = useState([])
  const [Trackers, setTrackers] = useState([])
  const [GripsValue, setGripsValue] = useState("Phone Grip")
  const [PopsocketsValue, setPopsocketsValue] = useState("Popsocket")
  const [TabletCaseValue, setTabletCaseValue] = useState("Tablet Case Sleeve")
  const [KeyboardValue, setKeyboardValue] = useState("Small Keyboard")
  const [StylusValue, setStylusValue] = useState("Stylus")
  const [TabletMountValue, setTabletMountValue] = useState("Tablet Stand Mount")
  const [ScreenSaverValue, setScreenSaverValue] = useState("Tablet Screen Protector")
  const [TrackersValue, setTrackersValue] = useState("Mobile Tracker")
  ...
  if (response.data.success) {
    ...
    setGrips(response.data.products)
  } else {
  }
  })
...
.then(response => {
  ...
  if (response.data.success) {
    ...
    setPopsockets(response.data.products)
  } else {
  }
  })
  ...
  if (response.data.success) {
    ...
    setTabletCase(response.data.products)
  } else {
  }
  })
  ...
  if (response.data.success) {
    ...
    setSmallKeyboard(response.data.products)
  } else {
  }
  })
  ...
  if (response.data.success) {
    ...
    setStylus(response.data.products)
  } else {
  }
  })
  ...
  if (response.data.success) {
    ...
    setTabletStand(response.data.products)
  } else {
  }
  })
  ...
  if (response.data.success) {
    ...
    setScreenSaver(response.data.products)
  } else {
  }
  })
  ...
  const SearchedProducts = Products.map((product, index) => {
    ...
    const GripsPage = Grips.map((product, index) => {
      return (
      ...
      const TabletCasePage = TabletCase.map((product, index) => {
        return (
          <div key={index} className='listing-Item'>
          <div className='listing-Details'>
              <a href={`/product/${product._id}`}> <div className='Item-image'>
        ...
        const PopsocketsPage = Popsockets.map((product, index) => {
          return (
            <div key={index} className='listing-Item'>
            <div className='listing-Details'>
                <a href={`/product/${product._id}`}> <div className='Item-image'>
          ...
          const SmallKeyboardPage = SmallKeyboard.map((product, index) => {
            return (
              <div key={index} className='listing-Item'>
              <div className='listing-Details'>
                  <a href={`/product/${product._id}`}> <div className='Item-image'>
            ...
            const StylusPage = Stylus.map((product, index) => {
              return (
                <div key={index} className='listing-Item'>
                <div className='listing-Details'>
                    <a href={`/product/${product._id}`}> <div className='Item-image'>
              ...
              const TabletStandPage = TabletStand.map((product, index) => {
                return (
                  <div key={index} className='listing-Item'>
                  <div className='listing-Details'>
                      <a href={`/product/${product._id}`}> <div className='Item-image'>
                ...
                const ScreenSaverPage = ScreenSaver.map((product, index) => {
                  return (
                    <div key={index} className='listing-Item'>
                    <div className='listing-Details'>
                        <a href={`/product/${product._id}`}> <div className='Item-image'>
    ...
    <div className='Page_banner-style'>
      ...
      <div className='RamPage_brand-options_box'>
        ...
        onClick={()=> {BrandCategory(1)}} >
          ...
          <div className={toggleBrands ===2 ? 'Ram_option_selected_style active-Ram_option_selected_style' : "Ram_option_selected_style"}
        onClick={()=> {BrandCategory(2)}} >
          <span>Small Keyboards</span>
          </div>
          <div className={toggleBrands ===3 ? 'Ram_option_selected_style active-Ram_option_selected_style' : "Ram_option_selected_style"}
        onClick={()=> {BrandCategory(3)}} >
          <span>AirTags & Trackers</span>
          </div>
...
<div className={togglePageCategory === 3 ? "Listed_fetched_products" : "Listed_fetched_products-hide"}>
  {ScreenSaverPage}
</div>
