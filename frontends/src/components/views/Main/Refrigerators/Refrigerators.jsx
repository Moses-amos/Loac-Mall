...
.then(response => {
  ...
  const FreezerOnTopPage = Refrigerators.map((product, index) => {
    ...
    const FreezerOnLeftPage = Refrigerators.map((product, index) => {
      ...
      const FreezerOnBottomPage = Refrigerators.map((product, index) => {
        ...
        const NoFreezerPage = Refrigerators.map((product, index) => {
