...
function WearGadgets() {
  ...
  const [WearableValue, setWearableValue] = useState("Wearable Tech")
  ...
  if (response.data.success) {
    ...
    setWearable(response.data.products)
  } else {
  }
  })
...
.then(response => {
  ...
  const SearchedProducts = Products.map((product, index) => {
    ...
    const WearablePage = Wearable.map((product, index) => {
          return (
