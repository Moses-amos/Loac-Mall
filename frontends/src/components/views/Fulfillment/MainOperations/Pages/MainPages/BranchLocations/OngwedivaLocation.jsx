...
function OngwedivaLocation() {
  ...
  useEffect(() => {
    ...
    const updateDeliveryConfirm = (productId, userId) => {
      ...
      storeAddress: UserData.ongwedivaAddress,
    ...
    const RenderStandingOrders = Branch.map((user, index) => {
      ...
      if(user && user.userLocation === "Ongwediva" ) {
        return (
          <>
            {userInfo.map(info => (
            <>
  ...
  return (
    ...
    <span className='Branch_title_box_span'>Ongwediva Orders</span>
      </div>
...
export default OngwedivaLocation