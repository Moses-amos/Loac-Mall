          ...
          <div className={toggleProfile? "Dropdown-account-Nav" : "Dropdown-account-hide"}>
              ...
              <div className='Dropdown-content'>
                <ul className='Dropdown-ul'>
                  <li className=" myAccount Dropdown-li-user">
                  ...
                  {user.userData.operateLocation === "Admin" || user.userData.accountTier === "Standard" || user.userData.accountTier === "Verified" ?
                  <li className="Dropdown-li-user">
                  <a className='Dropdown-a-user' href={`/0/${user.userData._id}`}>
                    <div className='Route-span-user'>
                      <span className='Route-span-style'>Seller Central</span>
                    </div>
                  ...
                  :
                  user.userData.accountTier === "Free" ?
                  <li className="Dropdown-li-user">
                  <a className='Dropdown-a-user' href='/free-account'>
                    <div className='Route-span-user'>
                      <span className='Route-span-style'>Seller Central</span>
                    </div>
                    <div className='Route-icon-user'>
