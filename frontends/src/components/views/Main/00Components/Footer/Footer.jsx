  ...
  <div className='Footer_Box'>
    <div style={{ display: 'flex', justifyContent: 'center'}}>
      <div style={{ width: '700px', display: 'flex', justifyContent: 'center'}}>
        <span className="In_store">We bring local Retail Stores onto a single online mall for shop-goers to browse, </span>
      </div>
    </div>
    <div style={{ display: 'flex', justifyContent: 'center'}}>
      <div style={{ width: '700px', marginBottom: '15px', display: 'flex', justifyContent: 'center'}}>
        <span className="In_store"> purchase, order products locally or across towns/city in Namibia.</span>
      </div>
    </div>
    {/* <div style={{ display: 'flex', justifyContent: 'center'}}>
      <span className='In_store'>In-store pricing may vary.</span>
    </div> */}
...
fill="white"></path></svg>
      ...
      <div style={{paddingTop: '10px'}}>
      <span className='Rights-span'>© 2023 Loac Mall All rights pending.</span>
    </div>
    </div>
