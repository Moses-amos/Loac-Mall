...
function Sidebar(props) {
    ...
    const popupModal = () => setModal(!modal)
...
return (
    <>
    <div className='Client_sidebar_button' onClick={popupModal}>
        <MenuOutlined />
    </div>

<div className={modal === true ? 'CLient-sidebar_container' : 'CLient-sidebar_hide'}>
    <ul className='User_page-sidebar'>
        <li onClick={popupModal}
         className='CLient-sidebar-header-User_main'>
            ...
            <div style={{ paddingLeft: '15px'}}>
                ...
                <div style={{ width: '170px', height: '80px', display: 'flex', alignItems: 'center'}}>
                Overview
                        </div>
                </NavLink>
                </div> </li> 
                <li onClick={popupModal}
                    ...
                    <div style={{ paddingLeft: '11px'}}>
                       ...
                       <li onClick={popupModal}
                            ...
                            <div style={{ paddingLeft: '15px'}}>
                                <div className='CLient-sidebar-titles-User' 
                                onClick={() => { refreshPage(); logoutHandler() }}
                                >
                                    <div style={{ width: '170px', height: '80px', display: 'flex', alignItems: 'center'}}>
                                    Logout
                                    </div>
