...
return (
    ...
    <div>
                ...
                :
                User.name ?
        <div style={{width: '99%', height: '80px', borderRadius: '7px',
    ...
    <ul className='sidebar-box'>
        <li className={toggleHeader===2 ? "Retailer-sidebar-header_hover Retailer-sidebar-header": "Retailer-sidebar-header"}
            onMouseEnter={() => switchHeader(2)} onMouseLeave={() => switchHeader()} >
                <span className='Retailer-sidebar-titles'>
    ...
    onMouseEnter={() => switchHeader(3)} onMouseLeave={() => switchHeader()} ><span className='Retailer-sidebar-titles'>
        <a style={{ width: '100%', height: '100%', display: 'flex',
