...
function CellularComponents() {
  ...
  const [ChargeCables, setChargeCables] = useState([])
  const [Powerbanks, setPowerbanks] = useState([])
  const [PhoneChargerValue, setPhoneChargerValue] = useState("Phone Charger")
  const [ChargeCableValue, setChargeCableValue] = useState("Charge Cable")
  const [PowerBankValue, setPowerBankValue] = useState("Powerbank")
...
.then(response => {
  ...
  if (response.data.success) {
    ...
    setChargeCables(response.data.products)
  } else {
  }
  })
  ...
  if (response.data.success) {
    ...
    setPowerbanks(response.data.products)
  } else {
  }
  })
...
getProducts(variables)
  ...
  const ChargersMicroPage = Chargers.map((product, index) => {
    return (
      ...
      <div className='Company-listing_logo'>
          ...
          const ChargeCablesMicroPage = ChargeCables.map((product, index) => {
            if (product.cableType === "Micro-USB") {
            return (
              <div key={index} className='listing-Item'>
              <div className='listing-Details'>
                  <a href={`/product/${product._id}`}> <div className='Item-image'>
            ...
            const ChargeCablesCtypePage = ChargeCables.map((product, index) => {
              if (product.cableType === "USB-C") {
              return (
                <div key={index} className='listing-Item'>
                <div className='listing-Details'>
                    <a href={`/product/${product._id}`}> <div className='Item-image'>
                ...
                const ChargeCablesLightningPage = ChargeCables.map((product, index) => {
                  if (product.cableType === "Lightning") {
                  return (
                    <div key={index} className='listing-Item'>
                    <div className='listing-Details'>
                        <a href={`/product/${product._id}`}> <div className='Item-image'>
                  ...
                  const PowerbanksPage = Powerbanks.map((product, index) => {
                    return (
                      <div key={index} className='listing-Item'>
                      <div className='listing-Details'>
                          <a href={`/product/${product._id}`}> <div className='Item-image'>
