...
function HomeSystems() {
  ...
  const [BabyMonitor, setBabyMonitor] = useState([])
  const [MotionSensor, setMotionSensor] = useState([])
  const [SmartTech, setSmartTech] = useState([])

  const [AssistantValue, setAssistantValue] = useState("Smart Assistant")
  const [HomeSystemValue, setHomeSystemValue] = useState("Smart Security System")
  const [DoorBellValue, setDoorBellValue] = useState("Smart Door System")
  const [BabyMonitorValue, setBabyMonitorValue] = useState("Baby Monitor")
  const [MotionSensorValue, setMotionSensorValue] = useState("Motion Sensor")
  const [SmartTechValue, setSmartTechValue] = useState("Smart Security System")
  ...
  if (response.data.success) {
    ...
    setAssistant(response.data.products)
  } else {
  }
  })
...
.then(response => {
  ...
  if (response.data.success) {
    ...
    setHomeSystem(response.data.products)
  } else {
  }
  })
  ...
  if (response.data.success) {
    ...
    setDoorBell(response.data.products)
  } else {
  }
  })
  ...
  if (response.data.success) {
    ...
    setBabyMonitor(response.data.products)
  } else {
  }
  })
  ...
  if (response.data.success) {
    ...
    setMotionSensor(response.data.products)
  } else {
  }
  })
  ...
  if (response.data.success) {
    ...
    setSmartTech(response.data.products)
  } else {
  }
  })
  ...
  const SearchedProducts = Products.map((product, index) => {
    ...
    const AssistantPage = Assistant.map((product, index) => {
      return (
      ...
      const HomeSystemPage = HomeSystem.map((product, index) => {
        return (
          <div key={index} className='listing-Item'>
          <div className='listing-Details'>
              <a href={`/product/${product._id}`}> <div className='Item-image'>
        ...
        const DoorBellPage = DoorBell.map((product, index) => {
          return (
            <div key={index} className='listing-Item'>
            <div className='listing-Details'>
                <a href={`/product/${product._id}`}> <div className='Item-image'>
          ...
          const BabyMonitorPage = BabyMonitor.map((product, index) => {
            return (
              <div key={index} className='listing-Item'>
              <div className='listing-Details'>
                  <a href={`/product/${product._id}`}> <div className='Item-image'>
            ...
            const MotionSensorPage = MotionSensor.map((product, index) => {
              return (
                <div key={index} className='listing-Item'>
                <div className='listing-Details'>
                    <a href={`/product/${product._id}`}> <div className='Item-image'>
              ...
              const SmartTechPage = SmartTech.map((product, index) => {
                return (
                  <div key={index} className='listing-Item'>
                  <div className='listing-Details'>
                      <a href={`/product/${product._id}`}> <div className='Item-image'>
  ...
  <div className={toggleBrands === 1 ? "Listed_fetched_products" : "Listed_fetched_products-hide"}>
    ...
    <div className={toggleBrands === 4 ? "Listed_fetched_products" : "Listed_fetched_products-hide"}>
      {AssistantPage}
    </div>

    <div className={toggleBrands === 5 ? "Listed_fetched_products" : "Listed_fetched_products-hide"}>
      {BabyMonitorPage}
    </div>

    <div className={toggleBrands === 6 ? "Listed_fetched_products" : "Listed_fetched_products-hide"}>
      {SmartTechPage}
    </div>
