...
function KatimaMuliloLocation() {
  ...
  useEffect(() => {
    ...
    const updateDeliveryConfirm = (productId, userId) => {
      ...
      storeAddress: UserData.katimaMuliloAddress,
    ...
    const RenderStandingOrders = Branch.map((user, index) => {
      ...
      if(user && user.userLocation === "KatimaMulilo" ) {
        return (
          <>
            {userInfo.map(info => (
            <>
  ...
  return (
    ...
    <span className='Branch_title_box_span'>Katima Mulilo Orders</span>
      </div>
...
export default KatimaMuliloLocation