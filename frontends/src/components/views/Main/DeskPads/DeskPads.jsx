...
function DeskPads() {
    ...
    const [DeskPads, setDeskPads] = useState([])
    const [CoolingPads, setCoolingPads] = useState([])
    const [DeskPadValue, setDeskPadValue] = useState("Desk Pad")
    const [CoolingPadValue, setCoolingPadValue] = useState("Cooling Pad")
    ...
    const popUpLogin = (index) => {
      ...
      if (response.data.success) {
        ...
        setDeskPads(response.data.products)
      } else {
      }
      })
      ...
      if (response.data.success) {
        ...
        setCoolingPads(response.data.products)
      } else {
      }
      })
      ...
      const SearchedProducts = Products.map((product, index) => {
        ...
        const DeskPadsPage = DeskPads.map((product, index) => {
            return (
            ...
            const CoolingPadsPage = CoolingPads.map((product, index) => {
              return (
                <div key={index} className='listing-Item'>
                <div className='listing-Details'>
                    <a href={`/product/${product._id}`}> <div className='Item-image'>
