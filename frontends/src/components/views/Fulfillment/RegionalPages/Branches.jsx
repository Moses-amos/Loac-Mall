...
import NoImage from '../MainOperations/Pages/MainPages/Images/No_Image.jpg'
...
Axios.post('/api/users/getHistorys')
.then(response => {
if (response.data.success) {
...
if(user && user.userLocation === UserData.userLocation ) {
return (
<>
  {userInfo.map(info => (
  <>
    ...
    <div key={index} className='TrackOrder-item_box_branch'>
      <div className='TrackOrder-item_top_section'>
        <div className='TrackOrder-item_image_box'>
          <BranchImages images={info.imageOne} />
        </div>
        ...
        <div style={{ paddingLeft: '20px', width: '420px'}}>
          <div>
          <div style={{ display: 'flex', position: 'absolute', zIndex: '1', marginLeft: '300px'}}>
          <button 
          ...
          style={{ fontSize: '11px', padding: '0px 10px', cursor: 'pointer',
           ...
           outline: 'none', display: 'flex', justifyContent: 'center', alignItems: 'center'}}>CANCEL ORDER</button>
            ...
            <>
            <div>
            <TextareaAutosize minRows={2} maxLength={110} placeholder='Tell buyer where to pickup the Item' style={{ width: '335px', outline: '2px solid orange', fontSize: '13px',
          ...
          <div style={{ marginTop: '5px'}}>
            ...
            <div style={{ width: '270px', paddingRight: '10px', overflow: 'hidden'}}>
                  <span className='Track-Order-item_delivery_address_p_branch'>Name: {user.name} {user.lastname}</span>
              </div>
              <div style={{ width: '130px', paddingRight: '10px', overflow: 'hidden'}}>
                  <span className='Track-Order-item_delivery_address_p_branch'>Nr: {user.contact}</span>
              </div>
            </div>
            <div style={{ marginTop: '5px'}}>
            <div style={{ display: 'flex', width: '100%'}}>
              <div style={{ width: '400px', paddingRight: '10px', overflow: 'hidden'}}>
  ...
  <>
    ...
    <div key={index} className='TrackOrder-item_box_branch'>
      <div className='TrackOrder-item_top_section'>
        ...
        <div style={{ paddingLeft: '20px', width: '420px'}}>
          <div>
          <div style={{ display: 'flex', position: 'absolute',zIndex: '1', marginLeft: '295px'}}>
          <button 
      ...
      <div className='TrackOrder-item_status_box'>
        ...
        <div className='TrackOrder-item_delivery_stages_box'>
          ...
          className='TrackOrder-item_delivery_delivered'>
            <span className='TrackOrder-item_delivery_stages-active'>
              Click When Buyer Buys & Picks up Item at Store
            </span>
          </div>
        </div>
      </div>
...
<div className='Branch_title_box'>
    ...
    <span className='Branch_title_box_span'>Windhoek Branch</span>
    :
    UserData.userLocation === "KatimaMulilo" ?
    <span className='Branch_title_box_span'>Katima Mulilo Branch</span>
    :
    UserData.userLocation === "Swakop" ?
    <span className='Branch_title_box_span'>Swakopmund Branch</span>
    :
    UserData.userLocation === "Walvis" ?
    <span className='Branch_title_box_span'>Walvis Bay Branch</span>
    :
    UserData.userLocation === "Oshakati" ?
    <span className='Branch_title_box_span'>Oshakati Branch</span>
    :
    UserData.userLocation === "Grootfontein" ?
    <span className='Branch_title_box_span'>Grootfontein Branch</span>
    :
    UserData.userLocation === "Rundu" ?
    <span className='Branch_title_box_span'>Rundu Branch</span>
    :
    UserData.userLocation === "Otjiwarongo" ?
    <span className='Branch_title_box_span'>Otjiwarongo Branch</span>
    :
    UserData.userLocation === "Ongwediva" ?
    <span className='Branch_title_box_span'>Ongwediva Branch</span>
    :
    UserData.userLocation === "Okahandja" ?
    <span className='Branch_title_box_span'>Okahandja Branch</span>
    :
    UserData.userLocation === "Gobabis" ?
    <span className='Branch_title_box_span'>Gobabis Branch</span>
    :
    UserData.userLocation === "Rehoboth" ?
    <span className='Branch_title_box_span'>Rehoboth Branch</span>
    :
    UserData.userLocation === "Tsumeb" ?
    <span className='Branch_title_box_span'>Tsumeb Branch</span>
    :
    <></>
    }
  </div>
  <div className='Branches-container_box'>
    <div className='Branches-delivery-toggle'>
      <div className='Branches-delivery-toggle_top'>
      ...
      <div className={toggleBranch===1 ? "active-Deliveries" :"Deliveries-hidden"}>
    ...
    <div className='TrackOrder-item_top_section'>
      ...
      <div style={{ paddingLeft: '20px', width: '420px'}}>
        ...
        <div style={{ marginTop: '5px'}}>
          <div style={{ display: 'flex'}}>
          <div style={{ width: '205px', paddingRight: '10px', overflow: 'hidden'}}>
                <span className='Track-Order-item_delivery_address_p_branch'>Name: Buyer Name</span>
            </div>
            <div style={{ width: '125px', paddingRight: '10px', overflow: 'hidden'}}>
                <span className='Track-Order-item_delivery_address_p_branch'>Nr: Number</span>
            </div>
          </div>
          <div style={{ marginTop: '5px'}}>
          <div style={{ display: 'flex', width: '100%'}}>
            <div style={{ width: '330px', paddingRight: '10px', overflow: 'hidden'}}>
    ...
    <></>
      ...
      <div className={toggleBranch===2 ? "active-Deliveries" :"Deliveries-hidden"}>
      {Branch.length === undefined ?
    <></>
    :
    Branch.length === 0 ?
    ...
    <></>
      ...
      <div className={toggleBranch===3 ? "active-Deliveries" :"Deliveries-hidden"}>
      {Branch.length === undefined ?
    <></>
    :
    Branch.length === 0 ?
    ...
    <></>
      ...
      <div className={toggleBranch===4 ? "active-Deliveries" :"Deliveries-hidden"}>
      {Branch.length === undefined ?
    <></>
    :
    Branch.length === 0 ?
