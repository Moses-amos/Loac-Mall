...
function RightMenu(props) {
  ...
  if (user.userData && !user.userData.isAuth) {
    return (
    //   <div className='Navbar-login_Signup' mode={props.mode}>
    //     <div className='Navbar-login_Signup_box'>
    //     <a href="/login">
    //       <span className='Navbar-login_Signup_span'>Login</span>
    //     </a>

    //     </div>
    //     <div className='Navbar-login_Signup_box'>
    //         <a href="/register">
    //           <span className='Navbar-login_Signup_span'>Signup</span>
    //         </a>
    //     </div>
    // </div>
    ...
    return (
        <div className='Navbar-selects-nav' mode={props.mode}>
            ...
            <div className='Account-span'>
              <a target='blank' style={{ textDecoration: 'none'}} href='/'>
                  <span className='Account-span_title'>Loac.com</span>
              </a>
              </div>
            </div> */}
          <div className='User-account-nav'> 
          {/* <div onClick={dropdownProfile} className='Account'>
            <div className='Account-span'>
            ...
            <div className='Account-span-user'>
              <div>
              <span className='Account-span_title'>Retailer Account</span>
            </div>
          ...
          <div className={toggleProfile? "Dropdown-account" : "Dropdown-account-hide"}>
              <div className='Dropdown-content'>
                ...
                <li onMouseEnter={()=> dropdownHover(1)} onMouseLeave={()=> dropdownHover(0)} className={dropdownColor ===1 ? "Dropdown-li-user myAccount Dropdown-li_hover" : " myAccount Dropdown-li-user"}>
                  <a className='Dropdown-a' href='/' target="_blank">
                    <div className='Route-myAccount-user'>
                      <span className='Route-span-account-user'>Loac.com</span>
                    </div>
                    </a>
                  </li>
                  ...
                  <a className='Dropdown-a-user' target='blank' onClick={() => { refreshPage(); logoutHandler() }}>
                    <div className='Route-span-user'>
