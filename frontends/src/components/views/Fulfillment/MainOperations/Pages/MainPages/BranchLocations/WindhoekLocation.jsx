  ...
  const RenderStandingOrders = Branch.map((user, index) => {
            ...
            <div className='TrackOrder_Branch-item_image_box'>
              ...
              <div style={{ paddingLeft: '20px', width: '350px'}}>
                ...
                style={{ fontSize: '11px', padding: '0px 10px', cursor: 'pointer',
                 ...
                 outline: 'none', display: 'flex', justifyContent: 'center', alignItems: 'center'}}>Cancel Request</button>
              </div>
                  ...
                  <div className='Track-Order-item_delivery_address_p_branch'>
                            ...
                            <>
                            <div>
                            <TextareaAutosize minRows={2} maxLength={110} placeholder='Tell buyer where to pickup the Item' style={{ width: '260px', outline: '1px solid orange', fontSize: '13px',
    ...
    <div className='TrackOrder_Branch-item_image_box'>
      ...
      <div style={{ paddingLeft: '20px', width: '350px'}}>
        ...
        style={{ fontSize: '11px', padding: '0px 10px', cursor: 'pointer',
         borderRadius: '5px', fontWeight: '700', background: '#c25be9', color: '#fff', border: '1px solid #1380e7',
         outline: 'none', display: 'flex', justifyContent: 'center', alignItems: 'center'}}>Restore Request</button>
      </div>
          <div style={{ position: 'relative'}}>
          <span className='TrackOrder-item_delivery_address_span'>Delivery Address</span>
          <div className='Track-Order-item_delivery_address_p_branch'>
                ...
                <div className='TrackOrder_Branch-item_title_box'>
                  ...
                  <div style={{ paddingLeft: '20px', width: '350px'}}>
                    ...
                    style={{ fontSize: '11px', padding: '0px 10px', cursor: 'pointer',
                     ...
                     alignItems: 'center'}}>Remove</button>
                  </div>
                      <div style={{ position: 'relative'}}>
                      <span className='TrackOrder-item_delivery_address_span'>Delivery Address</span>
                      <div className='Track-Order-item_delivery_address_p_branch'>
...
<span className='Branch_title_box_span'>Windhoek Orders</span>
  </div>
  <div className='Branches-container_box'>
    ...
    <div className='TrackOrder-item_top_section'>
      ...
      <div className='TrackOrder_Branch-item_title_box'>
        <div className='TrackOrder-item_title'>
          <span className='TrackOrder-item_title_span_branch'>This is where the title is shown.</span>
        </div>
        <div className='Track_Order-item_price-quantity'>
            <div className='Track_Order-item_price_box'>
              <div>
              ...
              <div className='TrackOrder-item_price-quantity_right'>
                <span className='TrackOrder-item_price-quantity_right_span_branch'>N$ 0.00</span>
              </div>
            </div>
            <div className='Track_Order-item_quantity_box'>
              <div>
              ...
              <div className='TrackOrder-item_price-quantity_right'>
                <span className='TrackOrder-item_price-quantity_right_span_branch'>0 </span>
              </div>
            </div>
          </div>
      </div>
      <div style={{ paddingLeft: '20px', width: '350px'}}>
        ...
        style={{ fontSize: '11px', padding: '0px 10px', cursor: 'pointer',
         ...
         outline: 'none', display: 'flex', justifyContent: 'center', alignItems: 'center'}}>Cancel Request</button>
          ...
          <div style={{ display: 'flex', marginTop: '10px'}}>
          <div>
          <TextareaAutosize minRows={2} maxLength={110} value='Tell buyer where to pickup the Item' style={{ width: '260px', outline: '1px solid orange', fontSize: '13px',
              fontWeight: '700', border: 'none', borderRadius: '2px', padding: '3px 2px', color: '#656481', position: 'relative', height: '30px'}}
          />
          </div>
          <div style={{ padding: '10px 0px 0px 0px', marginLeft: '15px'}}>
              ...
              style={{ cursor: 'pointer',width: '50px', height: '25px', display: 'flex',
               alignItems: 'center', justifyContent: 'center', border: 'none', outline: 'none',
                color: '#fff', fontSize: '13px', fontWeight: '500', background: 'orange',
                borderRadius: '3px'}}>Save</button>
          </div>
...
export default WindhoekLocation