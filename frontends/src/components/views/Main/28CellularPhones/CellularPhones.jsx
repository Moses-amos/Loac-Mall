...
import './cellularphones.css'

function CellularPhones() {
  ...
  const [IphoneValue, setIphoneValue] = useState("iPhone")
  const [TabletsValue, setTabletsValue] = useState("Tablet")
  const [IpadsValue, setIpadsValue] = useState("iPad")
  const [ReadersValue, setReadersValue] = useState("E Reader")
...
.then(response => {
  ...
  if (response.data.success) {
    ...
    setIpads(response.data.products)
  } else {
  }
  })
  ...
  if (response.data.success) {
    ...
    setReaders(response.data.products)
  } else {
  }
  })
...
getProducts(variables)
  ...
  const BrandCategory = (index) => {
    ...
    const SmartPhonesOtherPage = SmartPhones.map((product, index) => {
      if (product.seriesName === "Unlisted Android") {
      return (
          ...
          const SmartPhonesNokiaPage = SmartPhones.map((product, index) => {
            ...
            const SmartPhonesHisensePage = SmartPhones.map((product, index) => {
              ...
              const SmartPhonesXiaomiPage = SmartPhones.map((product, index) => {
                ...
                const SmartPhonesSonyPage = SmartPhones.map((product, index) => {
                  if (product.seriesName === "Sony") {
                  return (
                    <div key={index} className='listing-Item'>
                    <div className='listing-Details'>
                        <a href={`/product/${product._id}`}> <div className='Item-image'>
      ...
      const TabletsOtherPage = Tablets.map((product, index) => {
        if (product.seriesName === "Unlisted Tablet") {
        return (
          <div key={index} className='listing-Item'>
          <div className='listing-Details'>
              <a href={`/product/${product._id}`}> <div className='Item-image'>
        ...
        const TabletsGalaxyPage = Tablets.map((product, index) => {
          if (product.seriesName === "Galaxy Pad") {
          return (
            <div key={index} className='listing-Item'>
            <div className='listing-Details'>
                <a href={`/product/${product._id}`}> <div className='Item-image'>
          ...
          const TabletsLenovoPage = Tablets.map((product, index) => {
            if (product.seriesName === "Lenovo Pad") {
            return (
              <div key={index} className='listing-Item'>
              <div className='listing-Details'>
                  <a href={`/product/${product._id}`}> <div className='Item-image'>
            ...
            const TabletsKidsPage = Tablets.map((product, index) => {
              if (product.seriesName === "Kids Pad") {
              return (
                <div key={index} className='listing-Item'>
                <div className='listing-Details'>
                    <a href={`/product/${product._id}`}> <div className='Item-image'>
              ...
              const TabletsXiaomiPage = Tablets.map((product, index) => {
                if (product.seriesName === "Xiaomi Pad") {
                return (
                  <div key={index} className='listing-Item'>
                  <div className='listing-Details'>
                      <a href={`/product/${product._id}`}> <div className='Item-image'>
                ...
                const TabletsHuaweiPage = Tablets.map((product, index) => {
                  if (product.seriesName === "Huawei Pad") {
                  return (
                    <div key={index} className='listing-Item'>
                    <div className='listing-Details'>
                        <a href={`/product/${product._id}`}> <div className='Item-image'>
      ...
      const IpadsPage = Ipads.map((product, index) => {
        return (
          <div key={index} className='listing-Item'>
          <div className='listing-Details'>
              <a href={`/product/${product._id}`}> <div className='Item-image'>
        ...
        const ReadersPage = Readers.map((product, index) => {
          return (
            <div key={index} className='listing-Item'>
            <div className='listing-Details'>
                <a href={`/product/${product._id}`}> <div className='Item-image'>
          ...
          const IPhonesPage = Iphones.map((product, index) => {
            return (
              <div key={index} className='listing-Item'>
              <div className='listing-Details'>
                  <a href={`/product/${product._id}`}> <div className='Item-image'>
      ...
      <div className='RamPage_brand-options_box'>
       ...
       <div className={toggleBrands ===1 ? 'Phone_option_selected_style active-Ram_option_selected_style' : "Phone_option_selected_style"}
        ...
        onClick={()=> {BrandCategory(2)}} >
          ...
          <div className={toggleBrands ===3 ? 'Phone_option_selected_style active-Ram_option_selected_style' : "Phone_option_selected_style"}
        onClick={()=> {BrandCategory(3)}} >
          <span>Galaxy Pads</span>
          </div>
          <div className={toggleBrands ===4 ? 'Phone_option_selected_style active-Ram_option_selected_style' : "Phone_option_selected_style"}
        onClick={()=> {BrandCategory(4)}} >
          <span>Lenovo Pads</span>
          </div>
          <div className={toggleBrands ===8 ? 'Phone_option_selected_style active-Ram_option_selected_style' : "Phone_option_selected_style"}
        onClick={()=> {BrandCategory(8)}} >
          <span>Huawei Pads</span>
          </div>
          <div className={toggleBrands ===7 ? 'Phone_option_selected_style active-Ram_option_selected_style' : "Phone_option_selected_style"}
        onClick={()=> {BrandCategory(7)}} >
          <span>Xiaomi Pads</span>
          </div>
          <div className={toggleBrands ===5 ? 'Phone_option_selected_style active-Ram_option_selected_style' : "Phone_option_selected_style"}
        onClick={()=> {BrandCategory(5)}} >
          <span>E-Readers</span>
          ...
          <div className={toggleBrands ===6 ? 'Phone_option_selected_style active-Ram_option_selected_style' : "Phone_option_selected_style"}
        onClick={()=> {BrandCategory(6)}} >
          <span>Kids Tablets</span>
          </div>
        </div>
        <div className={togglePageCategory ===1 ? "Memory_size_options_listed" : "Memory_size_options_listed-hide"}>
          <div className='View_all_option'><a href="/smartphones" className='Memory_option-style_view'>View All</a></div>
        </div>
        <div className={togglePageCategory ===2 ? "Memory_size_options_listed" : "Memory_size_options_listed-hide"}>
          <div className='View_all_option'><a href="/tablets" className='Memory_option-style_view'>View All</a></div>
        </div>
      </div>
    </div>
  </div>
