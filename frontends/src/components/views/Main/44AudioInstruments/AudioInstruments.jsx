...
import './audioinstruments.css'

function AudioInstruments() {
    ...
    const [AudioMixers, setAudioMixers] = useState([])
    const [RecAmp, setRecAmp] = useState([])
    const [GuitarAmp, setGuitarAmp] = useState([])
    const [TurntableValue, setTurntableValue] = useState("Turntable")
    const [MixerValue, setMixerValue] = useState("Audio Mixer")
    const [RecAmpValue, setRecAmpValue] = useState("Audio Device")
    const [GuitarValue, setGuitarValue] = useState("Guitar Amp")
    ...
    const popUpLogin = (index) => {
      ...
      if (response.data.success) {
        ...
        setTurntables(response.data.products)
      } else {
      }
      })
    ...
    .then(response => {
      ...
      if (response.data.success) {
        ...
        setAudioMixers(response.data.products)
      } else {
      }
      })
      ...
      if (response.data.success) {
        ...
        setRecAmp(response.data.products)
      } else {
      }
      })
      ...
      if (response.data.success) {
        ...
        setGuitarAmp(response.data.products)
      } else {
      }
      })
      ...
      const SearchedProducts = Products.map((product, index) => {
        ...
        const TurntablesPage = Turntables.map((product, index) => {
          return (
          ...
          const AudioMixersPage = AudioMixers.map((product, index) => {
            return (
              <div key={index} className='listing-Item'>
              <div className='listing-Details'>
                  <a href={`/product/${product._id}`}> <div className='Item-image'>
            ...
            const GuitarAmpPage = GuitarAmp.map((product, index) => {
                return (
                  <div key={index} className='listing-Item'>
                  <div className='listing-Details'>
                      <a href={`/product/${product._id}`}> <div className='Item-image'>
            ...
            const RecieverPage = RecAmp.map((product, index) => {
                if (product.seriesName === "Reciever") {
                    return (
                      <div key={index} className='listing-Item'>
                      <div className='listing-Details'>
                          <a href={`/product/${product._id}`}> <div className='Item-image'>
                ...
                const AmplifierPage = RecAmp.map((product, index) => {
                    if (product.seriesName === "Amplifier") {
                        return (
                          <div key={index} className='listing-Item'>
                          <div className='listing-Details'>
                              <a href={`/product/${product._id}`}> <div className='Item-image'>
                    ...
                    const PreampPage = RecAmp.map((product, index) => {
                        if (product.seriesName === "Preamp") {
                            return (
                              <div key={index} className='listing-Item'>
                              <div className='listing-Details'>
                                  <a href={`/product/${product._id}`}> <div className='Item-image'>
...
export default AudioInstruments