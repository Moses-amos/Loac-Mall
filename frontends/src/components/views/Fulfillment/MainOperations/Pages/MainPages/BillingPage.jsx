...
import '../../../../Main/00Components/SellerAccountPlans/sellerplans.css'
...
function BillingPage(props) {
  ...
  return (
    <div className='Manage_Billing_Box'>
      <div className='Plans_box'>
                ...
                <div className='Plans_listed_box'>
                    <div className='Subscription_offered_box'>
                        ...
                        :
                        <div className='Plan_choice_box'>
                            <button onClick={() => {FreeAccountSelect()}} className='Plan_choice_button'>Try Free</button>
                        </div>
                        }
                    ...
                    <div className='Subscription_offered_box'>
                        ...
                        <div className='Plan_price_verify_box'>
                                <div className='Verify_plan_price'>
                                    <span className='Verify_plan_currency'>N$</span><span className='Verify_plan_amount'>300 /month</span>
                                </div>
