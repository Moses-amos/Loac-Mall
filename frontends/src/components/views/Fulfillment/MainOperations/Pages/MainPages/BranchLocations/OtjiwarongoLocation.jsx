...
function OtjiwarongoLocation() {
  ...
  useEffect(() => {
    ...
    const updateDeliveryConfirm = (productId, userId) => {
      ...
      storeAddress: UserData.otjiwarongoAddress,
    ...
    const RenderStandingOrders = Branch.map((user, index) => {
      ...
      if(user && user.userLocation === "Otjiwarongo" ) {
        return (
          <>
            {userInfo.map(info => (
            <>
  ...
  return (
    ...
    <span className='Branch_title_box_span'>Otjiwarongo Orders</span>
      </div>
...
export default OtjiwarongoLocation