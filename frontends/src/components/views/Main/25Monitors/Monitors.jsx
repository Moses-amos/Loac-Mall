...
function Monitors() {
  ...
  const [MonitorValue, setMonitorValue] = useState("Monitor")
  ...
  if (response.data.success) {
    ...
    setMonitors(response.data.products)
  } else {
  }
  })
...
.then(response => {
  ...
  const SearchedProducts = Products.map((product, index) => {
    ...
    const MonitorsPage = Monitors.map((product, index) => {
    ...
    const ThirtyUnderPage = Monitors.map((product, index) => {
      ...
      const ThirtyUpPage = Monitors.map((product, index) => {
        ...
        const MonitorsFlatPage = Monitors.map((product, index) => {
          if (product.functions === "Flat") {
          return (
            <div key={index} className='listing-Item'>
            <div className='listing-Details'>
                <a href={`/product/${product._id}`}> <div className='Item-image'>
        ...
        const ThirtyUnderFlatPage = Monitors.map((product, index) => {
          ...
          const ThirtyUpFlatPage = Monitors.map((product, index) => {
            if (product.displaySize === "33 inches & Up" && product.functions === "Flat") {
            return (
              <div key={index} className='listing-Item'>
              <div className='listing-Details'>
                  <a href={`/product/${product._id}`}> <div className='Item-image'>
            ...
            const MonitorsCurvedPage = Monitors.map((product, index) => {
            ...
            const ThirtyUnderCurvedPage = Monitors.map((product, index) => {
              ...
              const ThirtyUpCurvedPage = Monitors.map((product, index) => {
    ...
    <div className='RamPage_brand-options_box'>
      ...
      <div className={toggleBrands ===1 ? 'Ram_option_selected_style active-Ram_option_selected_style' : "Ram_option_selected_style"}
        ...
        {/* <div className='Memomry_size_option-list'>
          ...
          <div className='Memomry_size_option-list'>
          <button 
          className="Memory_size_option_selected_style Memory_size_option_selected_style-left"
          >Flat</button>
          <button
          className="Memory_size_option_selected_style Memory_size_option_selected_style-left">Curved</button>
          </div>
      </div>
      </div>
    </div>
...
<div className={toggleBrands === 1  ? "Listed_fetched_products" : "Listed_fetched_products-hide"}>
  {MonitorsPage}
</div>

<div className={toggleBrands === 2 ? "Listed_fetched_products" : "Listed_fetched_products-hide"}>
  {ThirtyUnderPage}
</div>

  <div className={toggleBrands === 3 ? "Listed_fetched_products" : "Listed_fetched_products-hide"}>
  {ThirtyUpPage}
</div>
