...
function SolidStateDrives() {
    ...
    const popUpLogin = (index) => {
      ...
      const SearchedProducts = Products.map((product, index) => {
        ...
        const SSDDrivesPage = SSDDrives.map((product, index) => {
                return (
            ...
            const TwoFiftySSDDrivesPage = SSDDrives.map((product, index) => {
                ...
                const FiftyTwelveSSDDrivesPage = SSDDrives.map((product, index) => {
                    ...
                    const OneTerabyteSSDDrivesPage = SSDDrives.map((product, index) => {
                        ...
                        const TwoTerabyteSSDDrivesPage = SSDDrives.map((product, index) => {
                            ...
                            const NotListedSSDDrivesPage = SSDDrives.map((product, index) => {
                                ...
                                const NVMeDrivesPage = NVMeDrives.map((product, index) => {
                                    return (
                                      <div key={index} className='listing-Item'>
                                      <div className='listing-Details'>
                                          <a href={`/product/${product._id}`}> <div className='Item-image'>
                                ...
                                const TwoFortyNVMeDrivesPage = NVMeDrives.map((product, index) => {
                                    if (product.storageCapacity === "240 GB") {
                                        return (
                                          <div key={index} className='listing-Item'>
                                          <div className='listing-Details'>
                                              <a href={`/product/${product._id}`}> <div className='Item-image'>
                                    ...
                                    const FourEightyNVMeDrivesPage = NVMeDrives.map((product, index) => {
                                        if (product.storageCapacity === "480 GB") {
                                            return (
                                              <div key={index} className='listing-Item'>
                                              <div className='listing-Details'>
                                                  <a href={`/product/${product._id}`}> <div className='Item-image'>
                                        ...
                                        const OneTerabyteNVMeDrivesPage = NVMeDrives.map((product, index) => {
                                            if (product.storageCapacity === "1 Terabyte") {
                                                return (
                                                  <div key={index} className='listing-Item'>
                                                  <div className='listing-Details'>
                                            ...
                                            const TwoTerabyteNVMeDrivesPage = NVMeDrives.map((product, index) => {
                                                if (product.storageCapacity === "2 Terabyte") {
                                                    return (
                                                      <div key={index} className='listing-Item'>
                                                      <div className='listing-Details'>
                                                ...
                                                const NotListedNVMeDrivesPage = NVMeDrives.map((product, index) => {
                                                    if (product.storageCapacity === "Not Listed") {
                                                        return (
                                                          <div key={index} className='listing-Item'>
                                                          <div className='listing-Details'>
...
export default SolidStateDrives