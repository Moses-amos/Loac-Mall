...
function RehobothLocation() {
  ...
  useEffect(() => {
    ...
    const updateDeliveryConfirm = (productId, userId) => {
      ...
      storeAddress: UserData.rehobothAddress,
    ...
    const RenderStandingOrders = Branch.map((user, index) => {
      ...
      if(user && user.userLocation === "Rehoboth" ) {
        return (
          <>
            {userInfo.map(info => (
            <>
  ...
  return (
    ...
    <span className='Branch_title_box_span'>Rehoboth Orders</span>
      </div>
...
export default RehobothLocation