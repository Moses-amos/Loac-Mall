...
import './computersoftware.css'

function ComputerSoftware() {
  ...
  const [OperatingValue, setOperatingValue] = useState("System Software")
  const [AntiVirusValue, setAntiVirusValue] = useState("Anti-Virus Software")
  const [ProgramsValue, setProgramsValue] = useState("Computer Software")
  ...
  if (response.data.success) {
    ...
    setOperating(response.data.products)
  } else {
  }
  })
...
.then(response => {
  ...
  if (response.data.success) {
    ...
    setAntiVirus(response.data.products)
  } else {
  }
  })
  ...
  if (response.data.success) {
    ...
    setPrograms(response.data.products)
  } else {
  }
  })
  ...
  const SearchedProducts = Products.map((product, index) => {
    ...
    const OperatingPage = Operating.map((product, index) => {
      return (
      ...
      const ProgramsPage = Programs.map((product, index) => {
        return (
          <div key={index} className='listing-Item'>
          <div className='listing-Details'>
              <a href={`/product/${product._id}`}> <div className='Item-image'>
      ...
      const AntiVirusPage = AntiVirus.map((product, index) => {
        return (
          <div key={index} className='listing-Item'>
          <div className='listing-Details'>
              <a href={`/product/${product._id}`}> <div className='Item-image'>
