...
function NotAvailableCity(props) {
  return (
    <>
    <div style={{ padding: '15px 0px 5px 0px'}}>
        <div style={{ position: 'relative'}}>
            <span style={{ fontSize: '16px', fontWeight: '700', color: '#656481'}}>Not Available In City</span>
        </div>
    ...
    <div style={{ padding: '0px 0px 20px 0px', display:'flex', flexWrap: 'wrap', width: '550px'}}>
                    ...
                    <></>
                    :
                    props.UserData && props.UserData.userLocation === "Windhoek" ?
                    <button className='Town_location-Not_present'>Windhoek</button>
                    :
                    props.UserData && props.UserData.userLocation === "Walvis" ?
                    <button className='Town_location-Not_present'>Walvis Bay</button>
                    :
                    props.UserData && props.UserData.userLocation === "Swakop" ?
                    <button className='Town_location-Not_present'>Swakopmund</button>
                    :
                    props.UserData && props.UserData.userLocation === "Okahandja" ?
                    <button className='Town_location-Not_present'>Okahandja</button>
                    :
                    props.UserData && props.UserData.userLocation === "Oshakati" ?
                    <button className='Town_location-Not_present'>Oshakati</button>
                    :
                    props.UserData && props.UserData.userLocation === "Grootfontein" ?
                    <button className='Town_location-Not_present'>Grootfontein</button>
                    :
                    props.UserData && props.UserData.userLocation === "Rehoboth" ?
                    <button className='Town_location-Not_present'>Rehoboth</button>
                    :
                    props.UserData && props.UserData.userLocation === "KatimaMulilo" ?
                    <button className='Town_location-Not_present'>Katima Mulilo</button>
                    :
                    props.UserData && props.UserData.userLocation === "Ongwediva" ?
                    <button className='Town_location-Not_present'>Ongwediva</button>
                    :
                    props.UserData && props.UserData.userLocation === "Otjiwarongo" ?
                    <button className='Town_location-Not_present'>Otjiwarongo</button>
                    :
                    props.UserData && props.UserData.userLocation === "Tsumeb" ?
                    <button className='Town_location-Not_present'>Tsumeb</button>
                    :
                    props.UserData && props.UserData.userLocation === "Gobabis" ?
                    <button className='Town_location-Not_present'>Gobabis</button>
                    :
                    props.UserData && props.UserData.userLocation === "Rundu" ?
                    <button className='Town_location-Not_present'>Rundu</button>
                    :
                    <></>
                    }
...
export default NotAvailableCity