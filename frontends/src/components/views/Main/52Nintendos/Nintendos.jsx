...
.then(response => {
  ...
  const SearchedProducts = Products.map((product, index) => {
    ...
    const NintendoSwitchSeventeenPage = NintendoConsole.map((product, index) => {
      ...
      const NintendoSwitchLitePage = NintendoConsole.map((product, index) => {
        ...
        const NintendoSwitchOledPage = NintendoConsole.map((product, index) => {
