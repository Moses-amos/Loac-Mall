...
function Washers() {
  ...
  const [CombosValue, setCombosValue] = useState("Washer Dryer Combo")
  const [WashersValue, setWashersValue] = useState("Wash Machine")
  ...
  if (response.data.success) {
    ...
    setWashers(response.data.products)
  } else {
  }
  })
...
.then(response => {
  ...
  if (response.data.success) {
    ...
    setCombos(response.data.products)
  } else {
  }
  })
  ...
  const SearchedProducts = Products.map((product, index) => {
    ...
    const WashersPage = Washers.map((product, index) => {
      return (
    ...
    const FrontLoadWashersPage = Washers.map((product, index) => {
      if (product.interface === "Front Load") {
        return (
          <div key={index} className='listing-Item'>
          <div className='listing-Details'>
              <a href={`/product/${product._id}`}> <div className='Item-image'>
      ...
      const TopLoadWashersPage = Washers.map((product, index) => {
        if (product.interface === "Top Load") {
          return (
            <div key={index} className='listing-Item'>
            <div className='listing-Details'>
                <a href={`/product/${product._id}`}> <div className='Item-image'>
        ...
        const CombosPage = Combos.map((product, index) => {
          return (
            <div key={index} className='listing-Item'>
            <div className='listing-Details'>
                <a href={`/product/${product._id}`}> <div className='Item-image'>
        ...
        const FrontLoadCombosPage = Combos.map((product, index) => {
          if (product.interface === "Front Load") {
            return (
              <div key={index} className='listing-Item'>
              <div className='listing-Details'>
          ...
          const TopLoadCombosPage = Combos.map((product, index) => {
            if (product.interface === "Top Load") {
              return (
                <div key={index} className='listing-Item'>
                <div className='listing-Details'>
