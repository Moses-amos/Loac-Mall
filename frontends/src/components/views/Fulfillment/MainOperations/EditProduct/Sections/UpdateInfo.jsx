...
const [HddSsdCount, setHddSsdCount] = useState("")
...
hddCount: HddSsdCount === "" ? Product.hddCount : HddSsdCount,
...
const onHddSsdSlotsChange = (event) => {
setHddSsdCount(event.currentTarget.value)
}
  ...
  <ul style={{ width: '100%', display: 'block', position: 'relative', padding: '15px 5px'}}>
    ...
    <li style={{ listStyle: 'none', width: '100%', display: 'block', marginTop: '20px', padding: '10px 0px', borderTop: '2px solid #c5cbd5'}}>
      ...
      <div style={{ width: '100%', paddingLeft: '25px'}}>
        <TextareaAutosize minRows={2} style={{ width: '610px', fontSize: '13px', color: '#656481', outline: '2px solid orange',
    ...
    {/* <li style={{ listStyle: 'none', width: '100%', display: 'flex', padding: '10px 0px'}}>
      <div style={{ width: '25%',  fontSize: '15px', color: '#74767c', fontWeight: 'bolder',paddingTop: '5px'}}>
    ...
    <ul style={{ width: '100%', display: 'block'}}>
      ...
      <li style={{ listStyle: 'none', width: '100%', display: 'flex', padding: '10px 0px'}}>
        <div style={{ width: '25%',  fontSize: '15px', color: '#74767c', fontWeight: 'bolder',paddingTop: '5px'}}>
          <span>Graphics Card Memory (VRAM)</span>
        </div>
        <div style={{ width: '75%', display: 'flex', paddingLeft: '20px'}}>
    ...
    <ul style={{ width: '100%', display: 'block'}}>
        ...
        <div style={{ width: '75%', display: 'flex', paddingLeft: '20px'}}>
          ...
          <div style={{ paddingLeft: '20px'}}>
            <span style={{ paddingRight: '15px', color: '#74767c', fontWeight: 'bolder'}}>NVMe</span> <input type="text" onChange={onNVMeChange}
              placeholder={Product.nvme} value={NVMeValue} style={{ width: '80px', height: '30px', fontSize: '13px', color: '#656481', outline: '2px solid #656481', fontWeight: 'bolder', border: 'none', borderRadius: '2px', paddingLeft: '5px'}} /></div>
          <div style={{ paddingLeft: '20px'}}>
            <span style={{ paddingRight: '15px', color: '#74767c', fontWeight: 'bolder'}}>M.2</span> <input type="text" onChange={onMtwoChange}
              placeholder={Product.mdotTwo} value={MtwoValue} style={{ width: '80px', height: '30px', fontSize: '13px', color: '#656481', outline: '2px solid #656481', fontWeight: 'bolder', border: 'none', borderRadius: '2px', paddingLeft: '5px'}} /></div>
        </div>
      </li>
      <li style={{ listStyle: 'none', width: '100%', display: 'flex', padding: '10px 0px'}}>
        <div style={{ width: '25%',  fontSize: '15px', color: '#74767c', fontWeight: 'bolder',paddingTop: '5px'}}>
      ...
      <li style={{ listStyle: 'none', width: '100%', display: 'flex', padding: '10px 0px'}}>
        ...
        <div style={{ width: '95%', display: 'flex', paddingLeft: '20px'}}>
          ...
          <div style={{ paddingLeft: '20px'}}>
            <span style={{ paddingRight: '10px',color: '#74767c', fontWeight: 'bolder'}}>SD Card Reader</span> <input type="text" onChange={onSDSlotChange}
    ...
    <ul style={{ width: '100%', display: 'block'}}>
      ...
      <li style={{ listStyle: 'none', width: '100%', display: 'flex', padding: '10px 0px'}}>
        <div style={{ width: '25%',  fontSize: '15px', color: '#74767c', fontWeight: 'bolder',paddingTop: '5px'}}>
          <span>Max Memory Supported</span>
        </div>
        <div style={{ width: '75%', display: 'flex', paddingLeft: '20px'}}>
    ...
    <ul style={{ width: '100%', display: 'block'}}>
      ...
      <li style={{ listStyle: 'none', width: '100%', display: 'flex', padding: '10px 0px'}}>
        <div style={{ width: '25%',  fontSize: '15px', color: '#74767c', fontWeight: 'bolder',paddingTop: '5px'}}>
          <span>Suitable Motherboards</span>
        </div>
        <div style={{ width: '75%', display: 'flex', paddingLeft: '20px'}}>
      ...
      <li style={{ listStyle: 'none', width: '100%', display: 'flex', padding: '10px 0px'}}>
        ...
        <div style={{ width: '85%', display: 'flex', paddingLeft: '20px'}}>
          <div> <span style={{ paddingRight: '10px', color: '#74767c', fontWeight: 'bolder'}}>HDD</span> <input type="text" onChange={onHddSsdSlotsChange}
              placeholder={Product.hddCount} value={HddSsdCount}  style={{ width: '40px', height: '30px', fontSize: '13px', color: '#656481', outline: '2px solid #656481', fontWeight: 'bolder',
              border: 'none', borderRadius: '2px', paddingLeft: '15px'}} /></div>
    ...
    <ul style={{ width: '100%', display: 'block'}}>
      ...
      <li style={{ listStyle: 'none', width: '100%', display: 'flex', padding: '10px 0px'}}>
        <div style={{ width: '25%',  fontSize: '15px', color: '#74767c', fontWeight: 'bolder',paddingTop: '5px'}}>
          <span>Output Tray Capacity</span>
        </div>
        <div style={{ width: '75%', display: 'flex', paddingLeft: '20px'}}>
      ...
      <li style={{ listStyle: 'none', width: '100%', display: 'flex', padding: '10px 0px'}}>
        <div style={{ width: '25%',  fontSize: '15px', color: '#74767c', fontWeight: 'bolder',paddingTop: '5px'}}>
          <span>Compatible Black Cartridge</span>
        </div>
        <div style={{ width: '75%', display: 'flex', paddingLeft: '20px'}}>
      ...
      <li style={{ listStyle: 'none', width: '100%', display: 'flex', padding: '10px 0px'}}>
        <div style={{ width: '25%',  fontSize: '15px', color: '#74767c', fontWeight: 'bolder',paddingTop: '5px'}}>
          <span>Compatible Color Cartridge</span>
        </div>
        <div style={{ width: '75%', display: 'flex', paddingLeft: '20px'}}>
    ...
    <li style={{ listStyle: 'none', width: '100%', display: 'flex', padding: '10px 0px'}}>
      ...
      <li style={{ listStyle: 'none', width: '100%', display: 'flex', padding: '10px 0px'}}>
        <div style={{ width: '25%',  fontSize: '15px', color: '#74767c', fontWeight: 'bolder',paddingTop: '5px'}}>
          <span>Compatible Motherboard:</span>
        </div>
        <div style={{ width: '75%', display: 'flex', paddingLeft: '20px'}}>
      ...
      <li style={{ listStyle: 'none', width: '100%', display: 'flex', padding: '10px 0px'}}>
        <div style={{ width: '25%',  fontSize: '15px', color: '#74767c', fontWeight: 'bolder',paddingTop: '5px'}}>
          <span>Supported Operating System</span>
        </div>
        <div style={{ width: '75%', display: 'flex', paddingLeft: '20px'}}>
