...
function StoreLocations(props) {
  ...
  return (
    <div className='Retailer_store_locations_main'>
    <div
      className='Store_locations_details_page_box'>
      ...
      <div style={{ width: '100%', height: '400px', paddingTop: '40px', paddingLeft: '0px'}}>
        <div>
            <span style={{ fontWeight: '700', fontSize: '18px', color: '#333'}}>Click to select the locations where the Brand has store branches</span>
        </div>
        <div>
            <div style={{ display: 'flex', marginTop: '50px'}}>
                ...
                <div style={{ marginLeft: '20px'}}>
                    <span style={{ fontWeight: '600', fontSize: '15px', color: '#61606f'}}>This color means - The location is Selected</span>
                </div>
            </div>
            <div style={{ display: 'flex', marginTop: '5px'}}>
                ...
                <div style={{ marginLeft: '20px'}}>
                    <span style={{ fontWeight: '600', fontSize: '15px', color: '#61606f'}}>This color means - The location is not Selected</span>
                </div>
            </div>
        </div>
        <div style={{ width: '100%', display: 'flex', alignItems: 'center', flexWrap: 'wrap', paddingTop: '50px' }}>
