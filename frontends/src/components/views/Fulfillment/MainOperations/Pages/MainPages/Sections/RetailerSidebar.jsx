...
return (
    ...
    <div className='Retailer_Sidebar-conatiner'>
    <div className='Retailer_sidebar_box'>
    <div>
                {User.name === undefined ?
                <></>
                :
        ...
        <div style={{width: '100%', height: '80px', borderRadius: '7px',
          background: '#fff', border: '2px solid royalblue'}}>
    ...
    onMouseEnter={() => switchHeader(3)} onMouseLeave={() => switchHeader()} ><span className='Retailer-sidebar-titles'><a style={{ width: '100%', height: '100%', display: 'flex',
            alignItems: 'center', padding: '7px 0px 2px 0px'}} href="/fulfilments">
        ...
        <li className={toggleHeader===4 ? "Retailer-sidebar-header_hover-add Retailer-sidebar-header_hover": "Retailer-sidebar-header_hover-add"}
    ...
    alignItems: 'center', justifyContent: 'center', padding: '5px 0px 5px 0px'}} 
    href="/item/upload"><span style={{color: '#fff', fontWeight: '600'}}>Add Product</span></a></span>
    </li>
    ...
    {User && User === undefined ?
                ...
                justifyContent: 'center', alignItems: 'center' }}><span style={{ color: '#fff'}}>Set Branches</span></a> 
                    </div>
                </li>
                    }
    ...
    <li className="Retailer_Branch_Locations_Select">
        <div className='Retailer_Branch_Locations_Select_span'>     
        <a href='/windhoek-branch' style={{ width: '100%', height: '100%', display: 'flex', 
    justifyContent: 'center', alignItems: 'center' }}><span style={{ color: '#fff'}}>Windhoek</span></a> 
        </div>
    </li>
    :
    <></>
...
{User.Walvis === true ?
    <li className="Retailer_Branch_Locations_Select">
    <div className='Retailer_Branch_Locations_Select_span'>     
    <a href='/walvis-bay-branch' style={{ width: '100%', height: '100%', display: 'flex', 
justifyContent: 'center', alignItems: 'center' }}><span style={{ color: '#fff'}}>Walvis Bay</span></a> 
    </div>
    </li>
    :
    <></>
...
{User.Swakop === true ?
    <li className="Retailer_Branch_Locations_Select">
    <div className='Retailer_Branch_Locations_Select_span'>     
    <a href='/swakopmund-branch' style={{ width: '100%', height: '100%', display: 'flex', 
justifyContent: 'center', alignItems: 'center' }}><span style={{ color: '#fff'}}>Swakopmund</span></a> 
    </div>
    </li>
    :
    <></>
...
{User.Oshakati === true ?
    <li className="Retailer_Branch_Locations_Select">
    <div className='Retailer_Branch_Locations_Select_span'>     
    <a href='/oshakati-branch' style={{ width: '100%', height: '100%', display: 'flex', 
justifyContent: 'center', alignItems: 'center' }}><span style={{ color: '#fff'}}>Oshakati</span></a> 
    </div>
</li>
    :
    <></>
...
{User.Okahandja === true ?
    <li className="Retailer_Branch_Locations_Select">
    <div className='Retailer_Branch_Locations_Select_span'>     
    <a href='/okahandja-branch' style={{ width: '100%', height: '100%', display: 'flex', 
justifyContent: 'center', alignItems: 'center' }}><span style={{ color: '#fff'}}>Okahandja</span></a> 
    </div>
</li>
    :
    <></>
...
{User.Grootfontein === true ?
    <li className="Retailer_Branch_Locations_Select">
    <div className='Retailer_Branch_Locations_Select_span'>     
    <a href='/grootfontein-branch' style={{ width: '100%', height: '100%', display: 'flex', 
justifyContent: 'center', alignItems: 'center' }}><span style={{ color: '#fff'}}>Grootfontein</span></a> 
    </div>
</li>
    :
    <></>
...
{User.Rehoboth === true ?
    <li className="Retailer_Branch_Locations_Select">
    <div className='Retailer_Branch_Locations_Select_span'>     
    <a href='/rehoboth-branch' style={{ width: '100%', height: '100%', display: 'flex', 
justifyContent: 'center', alignItems: 'center' }}><span style={{ color: '#fff'}}>Rehoboth</span></a> 
    </div>
</li>
    :
    <></>
...
{User.Gobabis === true ?
    <li className="Retailer_Branch_Locations_Select">
    <div className='Retailer_Branch_Locations_Select_span'>     
    <a href='/gobabis-branch' style={{ width: '100%', height: '100%', display: 'flex', 
justifyContent: 'center', alignItems: 'center' }}><span style={{ color: '#fff'}}>Gobabis</span></a> 
    </div>
</li>
    :
    <></>
...
{User.KatimaMulilo === true ?
    <li className="Retailer_Branch_Locations_Select">
    <div className='Retailer_Branch_Locations_Select_span'>     
    <a href='/katima-mulilo-branch' style={{ width: '100%', height: '100%', display: 'flex', 
justifyContent: 'center', alignItems: 'center' }}><span style={{ color: '#fff'}}>Katima Mulilo</span></a> 
    </div>
</li>
    :
    <></>
...
{User.Rundu === true ?
    <li className="Retailer_Branch_Locations_Select">
    <div className='Retailer_Branch_Locations_Select_span'>     
    <a href='/rundu-branch' style={{ width: '100%', height: '100%', display: 'flex', 
justifyContent: 'center', alignItems: 'center' }}><span style={{ color: '#fff'}}>Rundu</span></a> 
    </div>
</li>
    :
    <></>
...
{User.Ongwediva === true ?
    <li className="Retailer_Branch_Locations_Select">
    <div className='Retailer_Branch_Locations_Select_span'>     
    <a href='/ongwediva-branch' style={{ width: '100%', height: '100%', display: 'flex', 
justifyContent: 'center', alignItems: 'center' }}><span style={{ color: '#fff'}}>Ongwediva</span></a> 
    </div>
</li>
    :
    <></>
...
{User.Otjiwarongo === true ?
    <li className="Retailer_Branch_Locations_Select">
    <div className='Retailer_Branch_Locations_Select_span'>     
    <a href='/otjiwarongo-branch' style={{ width: '100%', height: '100%', display: 'flex', 
justifyContent: 'center', alignItems: 'center' }}><span style={{ color: '#fff'}}>Otjiwarongo</span></a> 
    </div>
</li>
    :
    <></>
...
{User.Tsumeb === true ?
    <li className="Retailer_Branch_Locations_Select">
    <div className='Retailer_Branch_Locations_Select_span'>     
    <a href='/tsumeb-branch' style={{ width: '100%', height: '100%', display: 'flex', 
justifyContent: 'center', alignItems: 'center' }}><span style={{ color: '#fff'}}>Tsumeb</span></a> 
    </div>
</li>
    :
    <></>
