...
function Theater() {
  ...
  const [SoundBarValue, setSoundBarValue] = useState("Sound Bar")
  const [DecodersValue, setDecodersValue] = useState("Decoder")
  const [MediasValue, setMediasValue] = useState("Streaming Device")
  const [StereosValue, setStereosValue] = useState("Stereo System")
  const [BlueRayValue, setBlueRayValue] = useState("Blue-Ray Player")
  const [PlayersValue, setPlayersValue] = useState("CD/DVD Player")
...
.then(response => {
  ...
  if (response.data.success) {
    ...
    setSoundBars(response.data.products)
  } else {
  }
  })
  ...
  if (response.data.success) {
    ...
    setMedias(response.data.products)
  } else {
  }
  })
  ...
  if (response.data.success) {
    ...
    setStereos(response.data.products)
  } else {
  }
  })
  ...
  if (response.data.success) {
    ...
    setPlayers(response.data.products)
  } else {
  }
  })
  ...
  const SearchedProducts = Products.map((product, index) => {
    ...
    const FlatscreensThirtyTwoPage = Flatscreens.map((product, index) => {
      ...
      const FlatscreensThirtyToFortyNinePage = Flatscreens.map((product, index) => {
        if (product.displaySize === "33 inches to 49 inches") {
        return (
          <div key={index} className='listing-Item'>
          <div className='listing-Details'>
              <a href={`/product/${product._id}`}> <div className='Item-image'>
        ...
        const FlatscreensFiftyToSixtyPage = Flatscreens.map((product, index) => {
          ...
          const FlatscreensSeventyUpPage = Flatscreens.map((product, index) => {
            if (product.displaySize === "70 inches & Up") {
            return (
              <div key={index} className='listing-Item'>
              <div className='listing-Details'>
                  <a href={`/product/${product._id}`}> <div className='Item-image'>
            ...
            const SoundBarsPage = SoundBars.map((product, index) => {
              return (
                <div key={index} className='listing-Item'>
                <div className='listing-Details'>
                    <a href={`/product/${product._id}`}> <div className='Item-image'>
              ...
              const DecodersPage = Decoders.map((product, index) => {
                ...
                const MediasPage = Medias.map((product, index) => {
                  return (
                    <div key={index} className='listing-Item'>
                    <div className='listing-Details'>
                        <a href={`/product/${product._id}`}> <div className='Item-image'>
                  ...
                  const PlayersPage = Players.map((product, index) => {
                    ...
                    const StereosPage = Stereos.map((product, index) => {
                      return (
                        <div key={index} className='listing-Item'>
                        <div className='listing-Details'>
                            <a href={`/product/${product._id}`}> <div className='Item-image'>
    ...
    <div className='Page_banner-style'>
      ...
      <div onClick={()=> {PageCategory(3); BrandCategory(1)}}
       className={togglePageCategory ===3 ? "Page-option_selects_toggle active-image_page_selected" : "Page-option_selects_toggle"}>
        ...
        <div className='Image_Description_hover_box'>
        <div className='Image_Description_hover'>
        Decoders, Streaming Devices & Players
        </div>
        </div>
      </div>
      </div>
      ...
      <div className='RamPage_brand-options_box'>
        ...
        onClick={()=> {BrandCategory(2)}} >
          ...
          <div className={toggleBrands ===3 ? 'Ram_option_selected_style active-Ram_option_selected_style' : "Ram_option_selected_style"}
        onClick={()=> {BrandCategory(3)}} >
          <span>Blue-Ray Players</span>
          </div>
          <div className={toggleBrands ===4 ? 'Ram_option_selected_style active-Ram_option_selected_style' : "Ram_option_selected_style"}
        onClick={()=> {BrandCategory(4)}} >
          <span>CD/DVD Players</span>
          </div>
        </div>
        <div className={togglePageCategory ===1 ? "Memory_size_options_listed" : "Memory_size_options_listed-hide"}>
          <div className='View_all_option'><a href="/flatscreens" className='Memory_option-style_view'>View All</a></div>
        </div>

        <div className={togglePageCategory ===2 && toggleBrands === 1 ? "Memory_size_options_listed" : "Memory_size_options_listed-hide"}>
          <div className='View_all_option'><a href="/sound-bars" className='Memory_option-style_view'>View All</a></div>
        </div>
        <div className={togglePageCategory ===2 && toggleBrands === 2 ? "Memory_size_options_listed" : "Memory_size_options_listed-hide"}>
          <div className='View_all_option'><a className='Memory_option-style_view'>View All</a></div>
        </div>
      </div>
    </div>
  </div>
