...
function ExternalDrives() {
    ...
    const popUpLogin = (index) => {
      ...
      const SearchedProducts = Products.map((product, index) => {
        ...
        const ExteranlHHDSPage = ExteranlHHDS.map((product, index) => {
            return (
        ...
        const TwoFiftyExteranlHHDSPage = ExteranlHHDS.map((product, index) => {
            ...
            const ThreeTwentyExteranlHHDSPage = ExteranlHHDS.map((product, index) => {
                ...
                const FiveHundredExteranlHHDSPage = ExteranlHHDS.map((product, index) => {
                    ...
                    const OneTerabyteExteranlHHDSPage = ExteranlHHDS.map((product, index) => {
                        ...
                        const TwoTerabyteExteranlHHDSPage = ExteranlHHDS.map((product, index) => {
                            ...
                            const ThreeTerabyteExteranlHHDSPage = ExteranlHHDS.map((product, index) => {
                                ...
                                const NotListedExteranlHHDSPage = ExteranlHHDS.map((product, index) => {
                                    ...
                                    const TwoFiftyExternalSSDSPage = ExternalSSDS.map((product, index) => {
                                        if (product.storageCapacity === "250 GB") {
                                            return (
                                              <div key={index} className='listing-Item'>
                                              <div className='listing-Details'>
                                        ...
                                        const ThreeTwentyExternalSSDSPage = ExternalSSDS.map((product, index) => {
                                            if (product.storageCapacity === "320 GB") {
                                                return (
                                                  <div key={index} className='listing-Item'>
                                                  <div className='listing-Details'>
                                            ...
                                            const FiveHundredExternalSSDSPage = ExternalSSDS.map((product, index) => {
                                                if (product.storageCapacity === "500 GB") {
                                                    return (
                                                      <div key={index} className='listing-Item'>
                                                      <div className='listing-Details'>
                                                ...
                                                const OneTerabyteExternalSSDSPage = ExternalSSDS.map((product, index) => {
                                                    if (product.storageCapacity === "1 Terabyte") {
                                                        return (
                                                          <div key={index} className='listing-Item'>
                                                          <div className='listing-Details'>
                                                    ...
                                                    const TwoTerabyteExternalSSDSPage = ExternalSSDS.map((product, index) => {
                                                        if (product.storageCapacity === "2 Terabyte") {
                                                            return (
                                                              <div key={index} className='listing-Item'>
                                                              <div className='listing-Details'>
                                                        ...
                                                        const ThreeTerabyteExternalSSDSPage = ExternalSSDS.map((product, index) => {
                                                            if (product.storageCapacity === "3 Terabyte") {
                                                                return (
                                                                  <div key={index} className='listing-Item'>
                                                                  <div className='listing-Details'>
                                                            ...
                                                            const NotListedExternalSSDSPage = ExternalSSDS.map((product, index) => {
                                                                if (product.storageCapacity === "Not Listed") {
                                                                    return (
                                                                      <div key={index} className='listing-Item'>
                                                                      <div className='listing-Details'>
