...
function Cameras() {
  ...
  const [ActionCamValue, setActionCamValue] = useState("Action Camera")
  ...
  if (response.data.success) {
    ...
    setCameras(response.data.products)
  } else {
  }
  })
...
.then(response => {
  ...
  if (response.data.success) {
    ...
    setAction(response.data.products)
  } else {
  }
  })
  ...
  const SearchedProducts = Products.map((product, index) => {
    ...
    const ActionCameraPage = Action.map((product, index) => {
      return (
    ...
    const DSLRPage = Cameras.map((product, index) => {
      if (product.cableType === "DSLR") {
      return (
        <div key={index} className='listing-Item'>
        <div className='listing-Details'>
            <a href={`/product/${product._id}`}> <div className='Item-image'>
    ...
    const BridgePage = Cameras.map((product, index) => {
      if (product.cableType === "Bridge") {
      return (
        <div key={index} className='listing-Item'>
        <div className='listing-Details'>
            <a href={`/product/${product._id}`}> <div className='Item-image'>
    ...
    const MirrorlessPage = Cameras.map((product, index) => {
      if (product.cableType === "Mirrorless") {
      return (
        <div key={index} className='listing-Item'>
        <div className='listing-Details'>
            <a href={`/product/${product._id}`}> <div className='Item-image'>
    ...
    const CompactPage = Cameras.map((product, index) => {
      if (product.cableType === "Compact") {
      return (
        <div key={index} className='listing-Item'>
        <div className='listing-Details'>
            <a href={`/product/${product._id}`}> <div className='Item-image'>
      ...
      const CamerasPage = Cameras.map((product, index) => {
        return (
          <div key={index} className='listing-Item'>
          <div className='listing-Details'>
              <a href={`/product/${product._id}`}> <div className='Item-image'>
