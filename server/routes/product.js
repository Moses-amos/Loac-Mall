...
router.get("/writerDeals", auth, (req, res) => {

    Product.find({brochure: req.user._id }, (err, doc) => {
        if (err) return res.json({ success: false, err });
        return res.status(200).send({
            success: true, doc
        });
...
router.get("/writerTopItems", auth, (req, res) => {

    Product.find({landingPage: req.user._id }, (err, doc) => {
        if (err) return res.json({ success: false, err });
        return res.status(200).send({
            success: true, doc
        });
...
router.post("/LandingPageTopItems", (req, res) => {

    Product.find({landingPage: req.body.userId }, (err, doc) => {
        if (err) return res.json({ success: false, err });
        return res.status(200).send({
            success: true, doc
        });
...
router.post("/LandingPageWriterDeals", (req, res) => {

    Product.find({brochure: req.body.userId }, (err, doc) => {
        if (err) return res.json({ success: false, err });
        return res.status(200).send({
            success: true, doc
        });
