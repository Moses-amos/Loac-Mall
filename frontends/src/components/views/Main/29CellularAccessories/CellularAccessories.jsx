...
import './cellularaccessories.css'

function CellularAccessories() {
  ...
  const [SefieSticks, setSefieSticks] = useState([])
  ...
  const [CasesValue, setCasesValue] = useState("Phone Case")
  const [MountsValue, setMountsValue] = useState("Phone Mount")
  const [TrackersValue, setTrackersValue] = useState("Mobile Tracker")
  const [SefieStickValue, setSefieStickValue] = useState("Selfie Stick")
  const [SaversValue, setSaversValue] = useState("Screen Protector")
...
.then(response => {
  ...
  if (response.data.success) {
    ...
    setCases(response.data.products)
  } else {
  }
  })
  ...
  if (response.data.success) {
    ...
    setMounts(response.data.products)
  } else {
  }
  })
  ...
  if (response.data.success) {
    ...
    setSefieSticks(response.data.products)
  } else {
  }
  })
  ...
  if (response.data.success) {
    ...
    setScreenSavers(response.data.products)
  } else {
  }
  })
  ...
  const SearchedProducts = Products.map((product, index) => {
    ...
    const ScreenSaversPage = ScreenSavers.map((product, index) => {
      return (
    ...
    const SefieSticksPage = SefieSticks.map((product, index) => {
      return (
        <div key={index} className='listing-Item'>
        <div className='listing-Details'>
            <a href={`/product/${product._id}`}> <div className='Item-image'>
    ...
    const MountsPage = Mounts.map((product, index) => {
      return (
        <div key={index} className='listing-Item'>
        <div className='listing-Details'>
            <a href={`/product/${product._id}`}> <div className='Item-image'>
    ...
    const CasesPage = Cases.map((product, index) => {
      return (
        <div key={index} className='listing-Item'>
        <div className='listing-Details'>
            <a href={`/product/${product._id}`}> <div className='Item-image'>
...
export default CellularAccessories