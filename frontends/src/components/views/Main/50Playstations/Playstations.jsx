...
.then(response => {
  ...
  const SearchedProducts = Products.map((product, index) => {
    ...
    const PlayStationThreeStandardPage = PlayStationConsoles.map((product, index) => {
      if (product.modelName === "PlayStation 3" && product.seriesName === "") {
          return (
      ...
      const PlayStationThreeSlimPage = PlayStationConsoles.map((product, index) => {
        if (product.modelName === "PlayStation 3" && product.seriesName === "Slim") {
            return (
              <div key={index} className='listing-Item'>
              <div className='listing-Details'>
                  <a href={`/product/${product._id}`}> <div className='Item-image'>
        ...
        const PlayStationThreeSuperSlimPage = PlayStationConsoles.map((product, index) => {
          if (product.modelName === "PlayStation 3" && product.seriesName === "Super Slim") {
              return (
                <div key={index} className='listing-Item'>
                <div className='listing-Details'>
                    <a href={`/product/${product._id}`}> <div className='Item-image'>
          ...
          const PlayStationFourStandardPage = PlayStationConsoles.map((product, index) => {
            if (product.modelName === "PlayStation 4" && product.seriesName === "") {
                return (
                  <div key={index} className='listing-Item'>
                  <div className='listing-Details'>
                      <a href={`/product/${product._id}`}> <div className='Item-image'>
            ...
            const PlayStationFourSlimPage = PlayStationConsoles.map((product, index) => {
              if (product.modelName === "PlayStation 4" && product.seriesName === "Slim") {
                  return (
                    <div key={index} className='listing-Item'>
                    <div className='listing-Details'>
                        <a href={`/product/${product._id}`}> <div className='Item-image'>
              ...
              const PlayStationFourProPage = PlayStationConsoles.map((product, index) => {
                if (product.modelName === "PlayStation 4" && product.seriesName === "Pro") {
                    return (
                      <div key={index} className='listing-Item'>
                      <div className='listing-Details'>
                          <a href={`/product/${product._id}`}> <div className='Item-image'>
                ...
                const PlayStationFiveStandardPage = PlayStationConsoles.map((product, index) => {
                  if (product.modelName === "PlayStation 5" && product.seriesName === "") {
                      return (
                        <div key={index} className='listing-Item'>
                        <div className='listing-Details'>
                            <a href={`/product/${product._id}`}> <div className='Item-image'>
                  ...
                  const PlayStationFiveDigitalPage = PlayStationConsoles.map((product, index) => {
                    if (product.modelName === "PlayStation 5" && product.seriesName === "Digital Edition") {
                        return (
                          <div key={index} className='listing-Item'>
                          <div className='listing-Details'>
                              <a href={`/product/${product._id}`}> <div className='Item-image'>
