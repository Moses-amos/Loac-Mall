...
function Printers() {
  ...
  const [Insk, setInsk] = useState([])
  const [Toners, setToners] = useState([])
  const [PrinterValue, setPrinterValue] = useState("Printer")
  const [ScannerValue, setScannerValue] = useState("Scanner")
  const [PhotoPrinterValue, setPhotoPrinterValue] = useState("Photo Printer")
  const [LabelPrinterValue, setLabelPrinterValue] = useState("Label Printer")
  const [InkValue, setInkValue] = useState("Ink")
  const [TonerValue, setTonerValue] = useState("Toner")
  ...
  if (response.data.success) {
    ...
    setPrinters(response.data.products)
  } else {
  }
  })
...
.then(response => {
  ...
  if (response.data.success) {
    ...
    setScanners(response.data.products)
  } else {
  }
  })
  ...
  if (response.data.success) {
    ...
    setPhotoPrinter(response.data.products)
  } else {
  }
  })
  ...
  if (response.data.success) {
    ...
    setLabelPrinter(response.data.products)
  } else {
  }
  })
  ...
  if (response.data.success) {
    ...
    setInsk(response.data.products)
  } else {
  }
  })
  ...
  if (response.data.success) {
    ...
    setToners(response.data.products)
  } else {
  }
  })
  ...
  const SearchedProducts = Products.map((product, index) => {
    ...
    const PrintersPage = Printers.map((product, index) => {
      if (product.powerSource === "Standard Printer") {
      return (
      ...
      const AllPrintersPage = Printers.map((product, index) => {
        if (product.powerSource === "All in 1 Printer") {
        return (
          <div key={index} className='listing-Item'>
          <div className='listing-Details'>
              <a href={`/product/${product._id}`}> <div className='Item-image'>
        ...
        const ScannerPage = Scanners.map((product, index) => {
          return (
            <div key={index} className='listing-Item'>
            <div className='listing-Details'>
                <a href={`/product/${product._id}`}> <div className='Item-image'>
          ...
          const PhotoPrinterPage = PhotoPrinter.map((product, index) => {
            return (
              <div key={index} className='listing-Item'>
              <div className='listing-Details'>
                  <a href={`/product/${product._id}`}> <div className='Item-image'>
            ...
            const LabelPrinterPage = LabelPrinter.map((product, index) => {
              return (
                <div key={index} className='listing-Item'>
                <div className='listing-Details'>
                    <a href={`/product/${product._id}`}> <div className='Item-image'>
              ...
              const InskPage = Insk.map((product, index) => {
                return (
                  <div key={index} className='listing-Item'>
                  <div className='listing-Details'>
                      <a href={`/product/${product._id}`}> <div className='Item-image'>
                ...
                const TonersPage = Toners.map((product, index) => {
                  return (
                    <div key={index} className='listing-Item'>
                    <div className='listing-Details'>
                        <a href={`/product/${product._id}`}> <div className='Item-image'>
  ...
  <div className={toggleBrands === 1 ? "Listed_fetched_products" : "Listed_fetched_products-hide"}>
    ...
    <div className={toggleBrands === 7 ? "Listed_fetched_products" : "Listed_fetched_products-hide"}>
      {InskPage}
    </div>
