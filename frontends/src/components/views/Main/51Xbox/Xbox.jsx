...
import XSConsole from './Images/XS.jpg'
import One from './Images/Xbox-One-Logo.jpg'
import ThreeSixty from './Images/x360.jpg'
import './xbox.css'
...
.then(response => {
  ...
  const SearchedProducts = Products.map((product, index) => {
    ...
    const XboxThreeSixtyStandardPage = XboxConsoles.map((product, index) => {
      if (product.modelName === "XBOX 360" && product.seriesName === "") {
          return (
      ...
      const XboxThreeSixtySPage = XboxConsoles.map((product, index) => {
        if (product.modelName === "XBOX 360" && product.seriesName === "S") {
            return (
              <div key={index} className='listing-Item'>
              <div className='listing-Details'>
                  <a href={`/product/${product._id}`}> <div className='Item-image'>
        ...
        const XboxThreeSixtyEPage = XboxConsoles.map((product, index) => {
          if (product.modelName === "XBOX 360" && product.seriesName === "E") {
              return (
                <div key={index} className='listing-Item'>
                <div className='listing-Details'>
                    <a href={`/product/${product._id}`}> <div className='Item-image'>
          ...
          const XboxOneStandardPage = XboxConsoles.map((product, index) => {
            if (product.modelName === "XBOX One" && product.seriesName === "") {
                return (
                  <div key={index} className='listing-Item'>
                  <div className='listing-Details'>
                      <a href={`/product/${product._id}`}> <div className='Item-image'>
            ...
            const XboxOneXPage = XboxConsoles.map((product, index) => {
              if (product.modelName === "XBOX One" && product.seriesName === "X") {
                  return (
                    <div key={index} className='listing-Item'>
                    <div className='listing-Details'>
                        <a href={`/product/${product._id}`}> <div className='Item-image'>
              ...
              const XboxOneSPage = XboxConsoles.map((product, index) => {
                if (product.modelName === "XBOX One" && product.seriesName === "S") {
                    return (
                      <div key={index} className='listing-Item'>
                      <div className='listing-Details'>
                          <a href={`/product/${product._id}`}> <div className='Item-image'>
                ...
                const XboxSeriesXPage = XboxConsoles.map((product, index) => {
                  if (product.modelName === "XBOX Series" && product.seriesName === "X") {
                      return (
                        <div key={index} className='listing-Item'>
                        <div className='listing-Details'>
                            <a href={`/product/${product._id}`}> <div className='Item-image'>
                  ...
                  const XboxSeriesSPage = XboxConsoles.map((product, index) => {
                    if (product.modelName === "XBOX Series" && product.seriesName === "S") {
                        return (
                          <div key={index} className='listing-Item'>
                          <div className='listing-Details'>
                              <a href={`/product/${product._id}`}> <div className='Item-image'>
    ...
    <div className='Page_banner-style'>
      ...
      <div onClick={()=> {PageCategory(1); BrandCategory(1)}}
       className={togglePageCategory ===1 ? "Page-option_selects_toggle active-image_page_selected" : "Page-option_selects_toggle"}>
        <img className="image_page_selected_console" 
        src={ThreeSixty}
        />
        <div className='Image_Description_hover_box_console'>
