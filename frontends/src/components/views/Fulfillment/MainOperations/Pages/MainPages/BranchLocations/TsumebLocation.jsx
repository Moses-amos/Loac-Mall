...
function TsumebLocation() {
  ...
  useEffect(() => {
    ...
    const updateDeliveryConfirm = (productId, userId) => {
      ...
      storeAddress: UserData.tsumebAddress,
    ...
    const RenderStandingOrders = Branch.map((user, index) => {
      ...
      if(user && user.userLocation === "Tsumeb" ) {
        return (
          <>
            {userInfo.map(info => (
            <>
  ...
  return (
    ...
    <span className='Branch_title_box_span'>Tsumeb Orders</span>
      </div>
