...
function Projectors() {
    ...
    const [ProjectorValue, setProjectorValue] = useState("Projector")

    useEffect(() => {
        const variable = {
          product: ProjectorValue
        }
      ...
      if (response.data.success) {
        ...
        setProjectors(response.data.products)
      } else {
      }
      })
    ...
    .then(response => {
      ...
      const SearchedProducts = Products.map((product, index) => {
        ...
        const ProjectorsPage = Projectors.map((product, index) => {
            return (
