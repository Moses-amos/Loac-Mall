...
function CardReaders() {
    ...
    const [MemoryReaders, setMemoryReaders] = useState([])
    const [MemoryReaderValue, setMemoryReaderValue] = useState("Memory Card Reader")
    ...
    useEffect(() => {
      ...
      if (response.data.success) {
        ...
        setMemoryReaders(response.data.products)
      } else {
      }
      })
      ...
      const SearchedProducts = Products.map((product, index) => {
        ...
        const MemoryReadersPage = MemoryReaders.map((product, index) => {
            return (
