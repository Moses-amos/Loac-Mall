...
import './audiosystems.css'

function AudioSystems() {
  ...
  const [StereoValue, setStereoValue] = useState("Stereo System")
  const [PlayerValue, setPlayerValue] = useState("CD/DVD Player")
  ...
  if (response.data.success) {
    ...
    setStereo(response.data.products)
  } else {
  }
  })
...
.then(response => {
  ...
  if (response.data.success) {
    ...
    setPlayer(response.data.products)
  } else {
  }
  })
  ...
  const SearchedProducts = Products.map((product, index) => {
    ...
    const StereoPage = Stereo.map((product, index) => {
      return (
      ...
      const PlayerPage = Player.map((product, index) => {
        return (
          <div key={index} className='listing-Item'>
          <div className='listing-Details'>
              <a href={`/product/${product._id}`}> <div className='Item-image'>
