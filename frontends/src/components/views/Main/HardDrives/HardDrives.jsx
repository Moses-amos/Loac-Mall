...
function HardDrives() {
    ...
    .then(response => {
      ...
      const InternalDrivesPage = InternalDrives.map((product, index) => {
        ...
        const OneSixtyInternalDrivesPage = InternalDrives.map((product, index) => {
            if (product.storageCapacity === "160 GB") {
                return (
                  <div key={index} className='listing-Item'>
                  <div className='listing-Details'>
                      <a href={`/product/${product._id}`}> <div className='Item-image'>
            ...
            const TwoFiftyInternalDrivesPage = InternalDrives.map((product, index) => {
                if (product.storageCapacity === "250 GB") {
                    return (
                      <div key={index} className='listing-Item'>
                      <div className='listing-Details'>
                          <a href={`/product/${product._id}`}> <div className='Item-image'>
                ...
                const ThreeTwentyInternalDrivesPage = InternalDrives.map((product, index) => {
                    if (product.storageCapacity === "320 GB") {
                        return (
                          <div key={index} className='listing-Item'>
                          <div className='listing-Details'>
                              <a href={`/product/${product._id}`}> <div className='Item-image'>
                    ...
                    const FiveHundredInternalDrivesPage = InternalDrives.map((product, index) => {
                        if (product.storageCapacity === "500 GB") {
                            return (
                              <div key={index} className='listing-Item'>
                              <div className='listing-Details'>
                                  <a href={`/product/${product._id}`}> <div className='Item-image'>
                        ...
                        const OneTerabyteInternalDrivesPage = InternalDrives.map((product, index) => {
                            if (product.storageCapacity === "1 Terabyte") {
                                return (
                                  <div key={index} className='listing-Item'>
                                  <div className='listing-Details'>
                                      <a href={`/product/${product._id}`}> <div className='Item-image'>
                            ...
                            const TwoTerabyteInternalDrivesPage = InternalDrives.map((product, index) => {
                                if (product.storageCapacity === "2 Terabyte") {
                                    return (
                                      <div key={index} className='listing-Item'>
                                      <div className='listing-Details'>
                                          <a href={`/product/${product._id}`}> <div className='Item-image'>
                                ...
                                const ThreeTerabyteInternalDrivesPage = InternalDrives.map((product, index) => {
                                    if (product.storageCapacity === "3 Terabyte") {
                                        return (
                                          <div key={index} className='listing-Item'>
                                          <div className='listing-Details'>
                                              <a href={`/product/${product._id}`}> <div className='Item-image'>
                                    ...
                                    const NotListedInternalDrivesPage = InternalDrives.map((product, index) => {
                                        if (product.storageCapacity === "Not Listed") {
                                            return (
                                              <div key={index} className='listing-Item'>
                                              <div className='listing-Details'>
                                                  <a href={`/product/${product._id}`}> <div className='Item-image'>
        ...
        const OneSixtyDesktopDrivesPage = DesktopDrives.map((product, index) => {
            if (product.storageCapacity === "160 GB") {
                return (
                  <div key={index} className='listing-Item'>
                  <div className='listing-Details'>
            ...
            const TwoFiftyDesktopDrivesPage = DesktopDrives.map((product, index) => {
                if (product.storageCapacity === "250 GB") {
                    return (
                      <div key={index} className='listing-Item'>
                      <div className='listing-Details'>
                ...
                const ThreeTwentyDesktopDrivesPage = DesktopDrives.map((product, index) => {
                    if (product.storageCapacity === "320 GB") {
                        return (
                          <div key={index} className='listing-Item'>
                          <div className='listing-Details'>
                    ...
                    const FiveHundredDesktopDrivesPage = DesktopDrives.map((product, index) => {
                        if (product.storageCapacity === "500 GB") {
                            return (
                              <div key={index} className='listing-Item'>
                              <div className='listing-Details'>
                        ...
                        const OneTerabyteDesktopDrivesPage = DesktopDrives.map((product, index) => {
                            if (product.storageCapacity === "1 Terabyte") {
                                return (
                                  <div key={index} className='listing-Item'>
                                  <div className='listing-Details'>
                            ...
                            const TwoTerabyteDesktopDrivesPage = DesktopDrives.map((product, index) => {
                                if (product.storageCapacity === "2 Terabyte") {
                                    return (
                                      <div key={index} className='listing-Item'>
                                      <div className='listing-Details'>
                                ...
                                const ThreeTerabyteDesktopDrivesPage = DesktopDrives.map((product, index) => {
                                    if (product.storageCapacity === "3 Terabyte") {
                                        return (
                                          <div key={index} className='listing-Item'>
                                          <div className='listing-Details'>
                                    ...
                                    const NotListedDesktopDrivesPage = DesktopDrives.map((product, index) => {
                                        if (product.storageCapacity === "Not Listed") {
                                            return (
                                              <div key={index} className='listing-Item'>
                                              <div className='listing-Details'>
  ...
  <div className='Page_banner-style'>
    ...
    <div className='RamPage_brand-options_box'>
        ...
        onClick={()=> {BrandCategory(8)}} >
            <span>3 Terabyte</span>
          </div>
          <div className={toggleBrands ===9 ? 'Phone_option_selected_style active-Ram_option_selected_style' : "Phone_option_selected_style"}
...
<div className={togglePageCategory === 1 && toggleBrands === 2 ? "Listed_fetched_products" : "Listed_fetched_products-hide"}>
  {OneSixtyInternalDrivesPage}
</div>

<div className={togglePageCategory === 1 && toggleBrands === 3 ? "Listed_fetched_products" : "Listed_fetched_products-hide"}>
  {TwoFiftyInternalDrivesPage}
</div>

<div className={togglePageCategory === 1 && toggleBrands === 4 ? "Listed_fetched_products" : "Listed_fetched_products-hide"}>
  {ThreeTwentyInternalDrivesPage}
</div>

<div className={togglePageCategory === 1 && toggleBrands === 5 ? "Listed_fetched_products" : "Listed_fetched_products-hide"}>
  {FiveHundredInternalDrivesPage}
</div>

<div className={togglePageCategory === 1 && toggleBrands === 6 ? "Listed_fetched_products" : "Listed_fetched_products-hide"}>
  {OneTerabyteInternalDrivesPage}
</div>

<div className={togglePageCategory === 1 && toggleBrands === 7 ? "Listed_fetched_products" : "Listed_fetched_products-hide"}>
  {TwoTerabyteInternalDrivesPage}
</div>

<div className={togglePageCategory === 1 && toggleBrands === 8 ? "Listed_fetched_products" : "Listed_fetched_products-hide"}>
  {ThreeTerabyteInternalDrivesPage}
</div>

<div className={togglePageCategory === 1 && toggleBrands === 9 ? "Listed_fetched_products" : "Listed_fetched_products-hide"}>
  {NotListedInternalDrivesPage}
</div>
...
<div className={togglePageCategory === 2 && toggleBrands === 2 ? "Listed_fetched_products" : "Listed_fetched_products-hide"}>
  {OneSixtyDesktopDrivesPage}
</div>

<div className={togglePageCategory === 2 && toggleBrands === 3 ? "Listed_fetched_products" : "Listed_fetched_products-hide"}>
  {TwoFiftyDesktopDrivesPage}
</div>

<div className={togglePageCategory === 2 && toggleBrands === 4 ? "Listed_fetched_products" : "Listed_fetched_products-hide"}>
  {ThreeTwentyDesktopDrivesPage}
</div>

<div className={togglePageCategory === 2 && toggleBrands === 5 ? "Listed_fetched_products" : "Listed_fetched_products-hide"}>
  {FiveHundredDesktopDrivesPage}
</div>

<div className={togglePageCategory === 2 && toggleBrands === 6 ? "Listed_fetched_products" : "Listed_fetched_products-hide"}>
  {OneTerabyteDesktopDrivesPage}
</div>

<div className={togglePageCategory === 2 && toggleBrands === 7 ? "Listed_fetched_products" : "Listed_fetched_products-hide"}>
  {TwoTerabyteDesktopDrivesPage}
</div>

<div className={togglePageCategory === 2 && toggleBrands === 8 ? "Listed_fetched_products" : "Listed_fetched_products-hide"}>
  {ThreeTerabyteDesktopDrivesPage}
</div>

<div className={togglePageCategory === 2 && toggleBrands === 9 ? "Listed_fetched_products" : "Listed_fetched_products-hide"}>
  {NotListedDesktopDrivesPage}
</div>
