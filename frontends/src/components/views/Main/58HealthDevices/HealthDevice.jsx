...
function HealthDevice() {
  ...
  const [HeartMonitor, setHeartMonitor] = useState([])
  const [HearingAid, setHearingAid] = useState([])
  const [MobilityAid, setMobilityAid] = useState([])
  const [Massager, setMassager] = useState([])
  const [MuscleMassager, setMuscleMassager] = useState([])
  const [WeightScale, setWeightScale] = useState([])
  const [ElectricThermometer, setElectricThermometer] = useState([])
  const [Inhaler, setInhaler] = useState([])
  const [HealthDevice, setHealthDevice] = useState([])
  const [SteamVaporizer, setSteamVaporizer] = useState([])

  const [BloodPressureValue, setBloodPressureValue] = useState("Blood Monitor")
  const [HeartMonitorValue, setHeartMonitorValue] = useState("Heart Monitor")
  const [HearingAidValue, setHearingAidValue] = useState("Hearing Aid")
  const [MobilityAidValue, setMobilityAidValue] = useState("Mobility Aid")
  const [MassagerValue, setMassagerValue] = useState("Massage Device")
  const [MuscleMassagerValue, setMuscleMassagerValue] = useState("Muscle Massager")
  const [WeightScaleValue, setWeightScaleValue] = useState("Weight Device")
  const [ElectricThermometerValue, setElectricThermometerValue] = useState("Thermometer Device")
  const [InhalerValue, setInhalerValue] = useState("Inhaler")
  const [HealthDeviceValue, setHealthDeviceValue] = useState("Health Item")
  const [SteamVaporizerValue, setSteamVaporizerValue] = useState("Steam Vaporizer")
  ...
  if (response.data.success) {
    ...
    setBloodPressure(response.data.products)
  } else {
  }
  })
...
.then(response => {
  ...
  if (response.data.success) {
    ...
    setHeartMonitor(response.data.products)
  } else {
  }
  })
  ...
  if (response.data.success) {
    ...
    setHearingAid(response.data.products)
  } else {
  }
  })
  ...
  if (response.data.success) {
    ...
    setMobilityAid(response.data.products)
  } else {
  }
  })
  ...
  if (response.data.success) {
    ...
    setMuscleMassager(response.data.products)
  } else {
  }
  })
  ...
  useEffect(() => {
    const variable = {
      product: ElectricThermometerValue
    }
  ...
  if (response.data.success) {
    ...
    setElectricThermometer(response.data.products)
  } else {
  }
  })
  ...
  if (response.data.success) {
    ...
    setInhaler(response.data.products)
  } else {
  }
  })
  ...
  if (response.data.success) {
    ...
    setHealthDevice(response.data.products)
  } else {
  }
  })
  ...
  if (response.data.success) {
    ...
    setSteamVaporizer(response.data.products)
  } else {
  }
  })
  ...
  const SearchedProducts = Products.map((product, index) => {
    ...
    const BloodPressurePage = BloodPressure.map((product, index) => {
          return (
          ...
          const HeartMonitorPage = HeartMonitor.map((product, index) => {
          return (
            <div key={index} className='listing-Item'>
            <div className='listing-Details'>
                <a href={`/product/${product._id}`}> <div className='Item-image'>
      ...
      const HearingAidPage = HearingAid.map((product, index) => {
        return (
          <div key={index} className='listing-Item'>
          <div className='listing-Details'>
              <a href={`/product/${product._id}`}> <div className='Item-image'>
    ...
    const MobilityAidPage = MobilityAid.map((product, index) => {
      return (
        <div key={index} className='listing-Item'>
        <div className='listing-Details'>
            <a href={`/product/${product._id}`}> <div className='Item-image'>
...
const MuscleMassagerPage = MuscleMassager.map((product, index) => {
  return (
    <div key={index} className='listing-Item'>
    <div className='listing-Details'>
        <a href={`/product/${product._id}`}> <div className='Item-image'>
...
const ElectricThermometerPage = ElectricThermometer.map((product, index) => {
  return (
    <div key={index} className='listing-Item'>
    <div className='listing-Details'>
        <a href={`/product/${product._id}`}> <div className='Item-image'>
...
const InhalerPage = Inhaler.map((product, index) => {
  return (
    <div key={index} className='listing-Item'>
    <div className='listing-Details'>
        <a href={`/product/${product._id}`}> <div className='Item-image'>
...
const HealthDevicePage = HealthDevice.map((product, index) => {
  return (
    <div key={index} className='listing-Item'>
    <div className='listing-Details'>
        <a href={`/product/${product._id}`}> <div className='Item-image'>
...
const SteamVaporizerPage = SteamVaporizer.map((product, index) => {
  return (
    <div key={index} className='listing-Item'>
    <div className='listing-Details'>
        <a href={`/product/${product._id}`}> <div className='Item-image'>
    ...
    <div className='Page_select-option'>
      ...
      <div className='RamPage_brand-options_box'>
        ...
        onClick={()=> {BrandCategory(3)}} >
          <span>Electric Thermometer</span>
          </div>
